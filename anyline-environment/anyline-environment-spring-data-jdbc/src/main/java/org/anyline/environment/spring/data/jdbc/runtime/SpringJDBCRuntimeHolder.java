...
public class SpringJDBCRuntimeHolder extends AbstractRuntimeHolder implements RuntimeHolder {
    ...
    public DataRuntime reg(String key, String datasource){
        ...
        ConfigTable.worker.regBean(template_key, define);

        JdbcTemplate template = ConfigTable.worker.getBean(template_key, JdbcTemplate.class);
    ...
    public static void close(String key){
        ...
        if(ConfigTable.worker.containsSingleton(key)){
            datasource = ConfigTable.worker.getSingleton(key);
            try {

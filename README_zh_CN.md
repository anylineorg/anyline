...
预置的 AI 智能体SKILL定义位于 ./.ai/skills/anyline/SKILL.md
...
## 有传统的ORM了，为什么还需要AnyLine
- 【[AnyLine与传统ORM的设计思想对比](http://doc.anyline.org/aa/3b_15735)】
- 【[AnyLine VS ORM：核心差异与选型指南](http://doc.anyline.org/aa/f1_15730)】


## 如何集成

只需要一个依赖、一个注解即可实现与springboot, netty等框架项目完美整合，参考【[入门系列](http://doc.anyline.org/ss/f5_1150)】  
常用示例可以参考【[示例代码](https://gitee.com/anyline/anyline-simple)】或【[测试用例](http://doc.anyline.org/cs)】

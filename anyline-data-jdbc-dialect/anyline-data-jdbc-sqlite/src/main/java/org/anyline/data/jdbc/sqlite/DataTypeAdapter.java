...
public class DataTypeAdapter extends org.anyline.data.jdbc.adapter.DataTypeAdapter {
    ...
    public DataTypeAdapter(){
        ...
        types.put("BINARY_DOUBLE"           , DataType.REAL               ); //     ,  ,oracle,
        types.put("BINARY_FLOAT"            , DataType.ILLEGAL            ); //     ,  ,oracle,
        types.put("BIGINT"                  , DataType.INTEGER            ); //mysql,  ,      ,mssql,
        types.put("BIGSERIAL"               , DataType.INTEGER            ); //     ,pg,
        types.put("BINARY"                  , DataType.BLOB               ); //mysql,  ,      ,mssql,
        types.put("BIT"                     , DataType.INTEGER            ); //mysql,pg,      ,mssql,
        types.put("BLOB"                    , DataType.BLOB               ); //mysql,  ,oracle,            ,sqlite
        types.put("BOOL"                    , DataType.INTEGER            ); //     ,pg
        types.put("BOX"                     , DataType.ILLEGAL            ); //     ,pg
        types.put("BYTEA"                   , DataType.BLOB               ); //     ,pg
        types.put("CHAR"                    , DataType.TEXT               ); //mysql,pg,oracle,mssql,
        types.put("CIDR"                    , DataType.ILLEGAL            ); //      pg
        types.put("CIRCLE"                  , DataType.TEXT               ); //      pg
        types.put("CLOB"                    , DataType.TEXT               ); //     ,  ,oracle
        types.put("DATE"                    , DataType.TEXT               ); //mysql,pg,oracle,mssql
        types.put("DATETIME"                , DataType.TEXT               ); //mysql,  ,      ,mssql
        types.put("DATETIME2"               , DataType.TEXT               ); //mysql,  ,      ,mssql
        types.put("DATETIMEOFFSET"          , DataType.INTEGER            ); //mysql,  ,      ,mssql
        types.put("DECIMAL"                 , DataType.REAL               ); //mysql,pg,oracle,mssql
        types.put("DOUBLE"                  , DataType.REAL               ); //mysql,
        types.put("ENUM"                    , DataType.ILLEGAL            ); //mysql,
        types.put("FLOAT"                   , DataType.REAL               ); //mysql,  ,oracle,mssql
        types.put("FLOAT4"                  , DataType.REAL               ); //     ,pg
        types.put("FLOAT8"                  , DataType.REAL               ); //     ,pg
        types.put("GEOGRAPHY"               , DataType.ILLEGAL            ); //     ,  ,      ,mssql
        types.put("GEOMETRY"                , DataType.REAL               ); //mysql
        ...
        types.put("INT"                     , DataType.INTEGER            ); //mysql,  ,      ,mssql,
        types.put("INT2"                    , DataType.INTEGER            ); //     ,pg
        types.put("INT4"                    , DataType.INTEGER            ); //     ,pg
        types.put("INT8"                    , DataType.INTEGER            ); //     ,pg
        ...
        types.put("MONEY"                   , DataType.REAL               ); //     ,pg,      ,mssql
        types.put("NUMBER"                  , DataType.REAL               ); //     ,  ,oracle
        types.put("NCHAR"                   , DataType.TEXT               ); //     ,  ,oracle,mssql
        types.put("NCLOB"                   , DataType.BLOB               ); //     ,  ,oracle
        types.put("NTEXT"                   , DataType.TEXT               ); //     ,  ,      ,mssql
        types.put("NVARCHAR"                , DataType.TEXT               ); //     ,  ,      ,mssql
        types.put("NVARCHAR2"               , DataType.TEXT               ); //     ,  ,oracle
        types.put("PATH"                    , DataType.ILLEGAL            ); //     ,pg
        types.put("MEDIUMBLOB"              , DataType.BLOB               ); //mysql,
        types.put("MEDIUMINT"               , DataType.INTEGER            ); //mysql,
        ...
        types.put("NUMERIC"                 , DataType.REAL               ); //mysql,  ,       ,mssql,sqlite
        ...
        types.put("SERIAL"                  , DataType.INTEGER            ); //     ,pg,
        types.put("SERIAL2"                 , DataType.INTEGER            ); //     ,pg,
        types.put("SERIAL4"                 , DataType.INTEGER            ); //     ,pg,
        types.put("SERIAL8"                 , DataType.INTEGER            ); //     ,pg,
        types.put("SET"                     , DataType.ILLEGAL            ); //mysql,
        types.put("SMALLDATETIME"           , DataType.TEXT               ); //     ,  ,      ,mssql
        types.put("SMALLMONEY"              , DataType.TEXT               ); //     ,  ,      ,mssql
        types.put("SMALLINT"                , DataType.INTEGER            ); //mysql,
        types.put("SMALLSERIAL"             , DataType.INTEGER            ); //     ,pg,
        ...
        types.put("TIME"                    , DataType.TEXT               ); //mysql,pg,      ,mssql
        types.put("TIMEZ"                   , DataType.TEXT               ); //     ,pg
        types.put("TIMESTAMP"               , DataType.INTEGER            ); //mysql,pg,oracle,mssql
        types.put("TIMESTAMP_LOCAL_ZONE"    , DataType.INTEGER            ); //     ,pg
        types.put("TIMESTAMP_ZONE"          , DataType.INTEGER            ); //     ,pg
        ...
        types.put("TINYINT"                 , DataType.INTEGER            ); //mysql,  ,      ,mssql
        types.put("TINYTEXT"                , DataType.TEXT               ); //mysql,
        types.put("VARBINARY"               , DataType.BLOB               ); //mysql,  ,      ,mssql
        types.put("VARCHAR"                 , DataType.TEXT               ); //mysql,pg,oracle,mssql
        types.put("VARCHAR2"                , DataType.TEXT               ); //     ,  ,oracle,
        types.put("XML"                     , DataType.TEXT               ); //     ,pg，      ,mssql
        types.put("YEAR"                    , DataType.INTEGER            ); //mysql,

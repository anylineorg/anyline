...
public class Parameter {
    ...
    public Parameter(String text, int startIndex, int endIndex, boolean isFunction) {
        this.text = text;
    ...
    public FunctionCall getCall() { return call; }
    ...
    public String toString() {
        return String.format("参数[%d-%d]: %s %s",
                startIndex, endIndex, text, isFunction ? "(函数)" : "(其他)");
    }
}
...
public enum MySQLGenusTypeMetadataAlias implements TypeMetadataAlias {
	...
	TIME                          ("TIME"                           ,StandardTypeMetadata.TIME                          , "TIME"     , "TIME({S})"     , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP                     , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   2,   2,  -1,  -1,  -1),
	...
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP                     , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   2,   2,  -1,  -1,  -1),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2,  -1,  -1,  -1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP                     , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   2,   2,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.TIMESTAMP                     , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   2,   2,  -1,  -1,  -1),
	TIMETZ                        ("TIMETZ"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.TIME                          ,   1,   1,   1,  -1,  -1,  -1),

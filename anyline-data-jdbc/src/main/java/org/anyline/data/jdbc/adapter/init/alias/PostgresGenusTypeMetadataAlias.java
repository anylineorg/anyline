...
public enum PostgresGenusTypeMetadataAlias implements TypeMetadataAlias {
	BIGINT                    ("BIGINT"                    ,StandardTypeMetadata.INT64                , "BIGINT"   , "BIGINT"       , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	INT2                      ("INT2"                      ,StandardTypeMetadata.INT16                , "SMALLINT" , "SMALLINT"     , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	PG_SNAPSHOT               ("PG_SNAPSHOT"               ,StandardTypeMetadata.PG_SNAPSHOT          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TIME                      ("TIME"                      ,StandardTypeMetadata.TIME                 ,   1,   1,   1,  -1,  -1,   6,  -1,  -1),
	TIMESTAMP                 ("TIMESTAMP"                 ,StandardTypeMetadata.TIMESTAMP            ,   1,   1,   2,  -1,  -1,   6,   1,   0),
	TIMESTAMPTZ               ("TIMESTAMPTZ"               ,StandardTypeMetadata.TIMESTAMPTZ          ,   1,   1,   1,  -1,  -1,   6,   1,   0),
	TIMEZ                     ("TIMEZ"                     ,StandardTypeMetadata.TIMEZ                ,   1,   1,   1,  -1,  -1,   6,  -1,  -1),
	...
	BINARY_FLOAT              ("BINARY_FLOAT"              ,StandardTypeMetadata.FLOAT4               ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	INTEGER                   ("INTEGER"                   ,StandardTypeMetadata.INT32                ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	MEDIUMINT                 ("MEDIUMINT"                 ,StandardTypeMetadata.INT16                ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TINYINT                   ("TINYINT"                   ,StandardTypeMetadata.INT8                 , "SMALLINT" , "SMALLINT"     , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	PostgresGenusTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
		this.input = input;
	...
	PostgresGenusTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
		this.standard = standard;
		this.meta = meta;
		this.formula = formula;
	...
	PostgresGenusTypeMetadataAlias(String input, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null , null, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	PostgresGenusTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}

	PostgresGenusTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
	...
	PostgresGenusTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, meta, formula, null, null, null, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	PostgresGenusTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale) {
	...
	PostgresGenusTypeMetadataAlias(String input, TypeMetadata standard) {
		this.input = input;
		this.standard = standard;
	}

...
public enum OracleGenusTypeMetadataAlias implements TypeMetadataAlias {
	BFILE                         ("BFILE"                          ,StandardTypeMetadata.BFILE                         ,   1,   1,   1,  -1,  -1,  -1),
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S})"                      , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP_WITH_LOCAL_ZONE     , "TIMESTAMP WITH LOCAL TIME ZONE" , "TIMESTAMP({S}) WITH LOCAL TIME ZONE" , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	...
	BIGINT                        ("BIGINT"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	BIGSERIAL                     ("BIGSERIAL"                      ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	BINARY                        ("BINARY"                         ,StandardTypeMetadata.BLOB                          ,   1,   1,   1,  -1,  -1,  -1),
	BINARY_FLOAT                  ("BINARY_FLOAT"                   ,StandardTypeMetadata.BINARY_FLOAT                  ,   1,   2,   1,  -1,  -1,  -1),
	...
	BIT                           ("BIT"                            ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	BIT_VARYING                   ("BIT VARYING"                    ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	BITMAP                        ("BITMAP"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	BOOL                          ("BOOL"                           ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	BOOLEAN                       ("BOOLEAN"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	...
	BYTEA                         ("BYTEA"                          ,StandardTypeMetadata.BLOB                          ,   1,   1,   1,  -1,  -1,  -1),
	CHARACTER                     ("CHARACTER"                      ,StandardTypeMetadata.VARCHAR                       ,   0,   1,   1,  -1,  -1,  -1),
	CHARACTER_VARYING             ("CHARACTER VARYING"              ,StandardTypeMetadata.VARCHAR                       , "VARCHAR"                        , "VARCHAR({L} {U})"                    , null   , null   , null   ,   0,   1,   1,  -1,  -1,  -1),
	...
	DATETIME64                    ("DateTime"                       ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9),
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9),
	DATETIME_WITH_TIME_ZONE       ("DATETIME WITH TIME ZONE"        ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	DATETIMEV2                    ("DATETIMEV2"                     ,StandardTypeMetadata.TIMESTAMP                     ,   1,   2,   1,  -1,  -1,   9),
	...
	DECIMAL                       ("DECIMAL"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	...
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	DOUBLE_PRECISION              ("DOUBLE PRECISION"               ,StandardTypeMetadata.FLOAT                         ,   1,   2,   3,  -1,  -1,  -1),
	...
	FLOAT4                        ("FLOAT4"                         ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1,  -1,  -1,  -1),
	FLOAT64                       ("Float64"                        ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	FLOAT8                        ("FLOAT8"                         ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1,  -1,  -1,  -1),
	...
	INT                           ("INT"                            ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INT128                        ("INT128"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INT16                         ("INT16"                          ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INT2                          ("INT2"                           ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INT256                        ("INT256"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INT32                         ("INT32"                          ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INT4                          ("INT4"                           ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INT4RANGE                     ("INT4RANGE"                      ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INT64                         ("INT64"                          ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INT8                          ("INT8"                           ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INT8RANGE                     ("INT8RANGE"                      ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INTEGER                       ("INTEGER"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	INTERVAL                      ("INTERVAL"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_DAY                  ("INTERVAL DAY"                   ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_DAY_HOUR             ("INTERVAL DAY TO HOUR"           ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_DAY_MINUTE           ("INTERVAL DAY TO MINUTE"         ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_DAY_SECOND           ("INTERVAL DAY TO SECOND"         ,StandardTypeMetadata.INTERVAL_DAY_SECOND           , "INTERVAL DAY TO SECOND"         , "INTERVAL DAY({P}) TO SECOND({S})"    , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),
	INTERVAL_HOUR                 ("INTERVAL HOUR"                  ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_HOUR_MINUTE          ("INTERVAL HOUR TO MINUTE"        ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_HOUR_SECOND          ("INTERVAL HOUR TO SECOND"        ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_MINUTE               ("INTERVAL MINUTE"                ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_MINUTE_SECOND        ("INTERVAL MINUTE TO SECOND"      ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_MONTH                ("INTERVAL MONTH"                 ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_SECOND               ("INTERVAL SECOND"                ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_YEAR                 ("INTERVAL YEAR"                  ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1,  -1,  -1,  -1),
	...
	JSON                          ("JSON"                           ,StandardTypeMetadata.CLOB                          ,   1,   1,   1,  -1,  -1,  -1),
	...
	MEDIUMINT                     ("MEDIUMINT"                      ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	MEDIUMTEXT                    ("MEDIUMTEXT"                     ,StandardTypeMetadata.CLOB                          ,   1,   1,   1,  -1,  -1,  -1),
	MONEY                         ("MONEY"                          ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	...
	NTEXT                         ("NTEXT"                          ,StandardTypeMetadata.NCLOB                         ,   1,   1,   1,  -1,  -1,  -1),
	NUMERIC                       ("NUMERIC"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	NUMRANGE                      ("NUMRANGE"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	NVARCHAR                      ("NVARCHAR"                       ,StandardTypeMetadata.NVARCHAR2                     ,   0,   1,   1,  -1,  -1,  -1),
	...
	REAL                          ("REAL"                           ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1,  -1,  -1,  -1),
	...
	SERIAL                        ("SERIAL"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	SERIAL2                       ("SERIAL2"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	SERIAL4                       ("SERIAL4"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	SERIAL8                       ("SERIAL8"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	...
	SMALLINT                      ("SMALLINT"                       ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	SMALLMONEY                    ("SMALLMONEY"                     ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	SMALLSERIAL                   ("SMALLSERIAL"                    ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	...
	SQL_DATETIMEOFFSET            ("SQL_DATETIMEOFFSET"             ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	...
	TEXT                          ("TEXT"                           ,StandardTypeMetadata.CLOB                          ,   1,   1,   1,  -1,  -1,  -1),
	TID                           ("TID"                            ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIME                          ("TIME"                           ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TIME_TZ_UNCONSTRAINED         ("TIME TZ UNCONSTRAINED"          ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   1,   1,  -1,  -1,   9),
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   1,   1,  -1,  -1,   9),
	TIME_WITHOUT_ZONE             ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME_WITHOUT_TIME_ZONE        , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   1,  -1,  -1,   9),
	TIME_WITHOUT_TIME_ZONE        ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME_WITHOUT_TIME_ZONE        , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   1,  -1,  -1,   9),
	TIME_UNCONSTRAINED            ("TIME_UNCONSTRAINED"             ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   ,   1,   2,   1,  -1,  -1,   9),
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TIMETZ                        ("TIMETZ"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TINYBLOB                      ("TINYBLOB"                       ,StandardTypeMetadata.BLOB                          ,   1,   1,   1,  -1,  -1,  -1),
	TINYINT                       ("TINYINT"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2,  -1,  -1,  -1),
	TINYTEXT                      ("TINYTEXT"                       ,StandardTypeMetadata.CLOB                          ,   1,   1,   1,  -1,  -1,  -1),
	...
	VARCHAR                       ("VARCHAR"                        ,StandardTypeMetadata.VARCHAR2                      ,   0,   1,   1,  -1,  -1,  -1),

...
public enum OracleGenusTypeMetadataAlias implements TypeMetadataAlias {
	...
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP_WITH_LOCAL_ZONE     , "TIMESTAMP WITH LOCAL TIME ZONE" , "TIMESTAMP({S}) WITH LOCAL TIME ZONE" , null   , null   , null   ,   1,   2,   1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   2,   1),
	...
	BINARY_FLOAT                  ("BINARY_FLOAT"                   ,StandardTypeMetadata.BINARY_FLOAT                  ,   1,   2,   1),
	...
	BOOLEAN                       ("BOOLEAN"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	...
	CLICKHOUSE_DATETIME64         ("DATETIME64"                     ,StandardTypeMetadata.DATETIME                      , "DATETIME"                       , "DATETIME({S})"                       , null   , null   , null   ,   1,   1,   2),
	...
	CLICKHOUSE_DECIMAL128         ("DECIMAL128"                     ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_DECIMAL256         ("DECIMAL256"                     ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_DECIMAL32          ("DECIMAL32"                      ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_DECIMAL64          ("DECIMAL64"                      ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	DENSE_VECTOR                  ("dense_vector"                   ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	DOUBLE_PRECISION              ("DOUBLE PRECISION"               ,StandardTypeMetadata.FLOAT                         ,   1,   2,   3),
	...
	CLICKHOUSE_FLOAT32            ("FLOAT32"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	FLOAT4                        ("FLOAT4"                         ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1),
	CLICKHOUSE_FLOAT64            ("FLOAT64"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	FLOAT8                        ("FLOAT8"                         ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1),
	...
	CLICKHOUSE_INT128             ("INT128"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	INT128                        ("INT128"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_INT16              ("INT16"                          ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	...
	CLICKHOUSE_INT256             ("INT256"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_INT32              ("INT32"                          ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	INT32                         ("INT32"                          ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	INT4                          ("INT4"                           ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	INT4RANGE                     ("INT4RANGE"                      ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	INT64                         ("INT64"                          ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_INT64              ("INT64"                          ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	INT8                          ("INT8"                           ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_INT8               ("INT8"                           ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	INT8RANGE                     ("INT8RANGE"                      ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	INTEGER                       ("INTEGER"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	INTERVAL                      ("INTERVAL"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	INTERVAL_DAY                  ("INTERVAL DAY"                   ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	INTERVAL_DAY_HOUR             ("INTERVAL DAY TO HOUR"           ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	INTERVAL_DAY_MINUTE           ("INTERVAL DAY TO MINUTE"         ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	INTERVAL_DAY_SECOND           ("INTERVAL DAY TO SECOND"         ,StandardTypeMetadata.INTERVAL_DAY_SECOND           , "INTERVAL DAY TO SECOND"         , "INTERVAL DAY({P}) TO SECOND({S})"    , null   , null   , null   ,   1,   2,   2),
	INTERVAL_HOUR                 ("INTERVAL HOUR"                  ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	INTERVAL_HOUR_MINUTE          ("INTERVAL HOUR TO MINUTE"        ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	INTERVAL_HOUR_SECOND          ("INTERVAL HOUR TO SECOND"        ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	INTERVAL_MINUTE               ("INTERVAL MINUTE"                ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	INTERVAL_MINUTE_SECOND        ("INTERVAL MINUTE TO SECOND"      ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	INTERVAL_MONTH                ("INTERVAL MONTH"                 ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	INTERVAL_SECOND               ("INTERVAL SECOND"                ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	INTERVAL_YEAR                 ("INTERVAL YEAR"                  ,StandardTypeMetadata.ILLEGAL                       ,   1,  -1,  -1),
	...
	REAL                          ("REAL"                           ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1),
	...
	CLICKHOUSE_UINT128            ("UINT128"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_UINT16             ("UINT16"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_UINT256            ("UINT256"                        ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_UINT32             ("UINT32"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_UINT64             ("UINT64"                         ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	CLICKHOUSE_UINT8              ("UINT8"                          ,StandardTypeMetadata.NUMBER                        ,   1,   2,   2),
	...
	VARCHAR                       ("VARCHAR"                        ,StandardTypeMetadata.VARCHAR2                      ,   0,   1,   1),

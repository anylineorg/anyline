...
public enum OracleGenusTypeMetadataAlias implements TypeMetadataAlias {
	...
	TIMESTAMP                 ("TIMESTAMP"                 ,StandardTypeMetadata.TIMESTAMP             , "TIMESTAMP"              , "TIMESTAMP({S}) {Z}"               , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9,   1,   1),
	...
	BINARY_FLOAT              ("BINARY_FLOAT"              ,StandardTypeMetadata.BINARY_FLOAT          ,   1,   2,   1,  -1,  -1,  -1,  -1,  -1),
	...
	BOOLEAN                   ("BOOLEAN"                   ,StandardTypeMetadata.NUMBER                ,   1,   2,   2,  -1,  -1,  -1,  -1,  -1),
	...
	CHARACTER_VARYING         ("CHARACTER VARYING"         ,StandardTypeMetadata.VARCHAR               , "VARCHAR"                , "VARCHAR({L} {U})"                 , null   , null   , null   ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	DATETIME64                ("DateTime"                  ,StandardTypeMetadata.TIMESTAMP             , "TIMESTAMP"              , "TIMESTAMP({S}) "                  , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9,  -1,  -1),
	DATETIME                  ("DATETIME"                  ,StandardTypeMetadata.TIMESTAMP             , "TIMESTAMP"              , "TIMESTAMP({S}) "                  , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9,  -1,  -1),
	DATETIME2                 ("DATETIME2"                 ,StandardTypeMetadata.TIMESTAMP             , "TIMESTAMP"              , "TIMESTAMP({S}) "                  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9,  -1,  -1),
	DATETIMEOFFSET            ("DATETIMEOFFSET"            ,StandardTypeMetadata.TIMESTAMP             , "TIMESTAMP"              , "TIMESTAMP({S}) "                  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9,  -1,  -1),
	DATETIMEV2                ("DATETIMEV2"                ,StandardTypeMetadata.TIMESTAMP             ,   1,   2,   1,  -1,  -1,   9,  -1,  -1),
	...
	DOUBLE_PRECISION          ("DOUBLE PRECISION"          ,StandardTypeMetadata.FLOAT                 ,   1,   2,   3,  -1,  -1,  -1,  -1,  -1),
	...
	FLOAT4                    ("FLOAT4"                    ,StandardTypeMetadata.FLOAT                 ,   1,   2,   1,  -1,  -1,  -1,  -1,  -1),
	FLOAT64                   ("Float64"                   ,StandardTypeMetadata.NONE                  ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	FLOAT8                    ("FLOAT8"                    ,StandardTypeMetadata.FLOAT                 ,   1,   2,   1,  -1,  -1,  -1,  -1,  -1),
	...
	INT4RANGE                 ("INT4RANGE"                 ,StandardTypeMetadata.NUMBER                ,   1,   2,   2,  -1,  -1,  -1,  -1,  -1),
	INT64                     ("INT64"                     ,StandardTypeMetadata.NUMBER                ,   1,   2,   2,  -1,  -1,  -1,  -1,  -1),
	INT8                      ("INT8"                      ,StandardTypeMetadata.NUMBER                ,   1,   2,   2,  -1,  -1,  -1,  -1,  -1),
	INT8RANGE                 ("INT8RANGE"                 ,StandardTypeMetadata.NUMBER                ,   1,   2,   2,  -1,  -1,  -1,  -1,  -1),
	INTEGER                   ("INTEGER"                   ,StandardTypeMetadata.NUMBER                ,   1,   2,   2,  -1,  -1,  -1,  -1,  -1),
	INTERVAL                  ("INTERVAL"                  ,StandardTypeMetadata.NONE                  ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_DAY              ("INTERVAL DAY"              ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_DAY_HOUR         ("INTERVAL DAY TO HOUR"      ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_DAY_MINUTE       ("INTERVAL DAY TO MINUTE"    ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_DAY_SECOND       ("INTERVAL DAY TO SECOND"    ,StandardTypeMetadata.INTERVAL_DAY_SECOND   , "INTERVAL DAY TO SECOND" , "INTERVAL DAY({P}) TO SECOND({S})" , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_HOUR             ("INTERVAL HOUR"             ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_HOUR_MINUTE      ("INTERVAL HOUR TO MINUTE"   ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_HOUR_SECOND      ("INTERVAL HOUR TO SECOND"   ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_MINUTE           ("INTERVAL MINUTE"           ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_MINUTE_SECOND    ("INTERVAL MINUTE TO SECOND" ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_MONTH            ("INTERVAL MONTH"            ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_SECOND           ("INTERVAL SECOND"           ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	INTERVAL_YEAR             ("INTERVAL YEAR"             ,StandardTypeMetadata.ILLEGAL               ,   1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	REAL                      ("REAL"                      ,StandardTypeMetadata.FLOAT                 ,   1,   2,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SMALLDATETIME             ("SMALLDATETIME"             ,StandardTypeMetadata.TIMESTAMP             , "TIMESTAMP"              , "TIMESTAMP({S}) "                  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9,  -1,  -1),
	...
	SQL_DATETIMEOFFSET        ("SQL_DATETIMEOFFSET"        ,StandardTypeMetadata.TIMESTAMP             , "TIMESTAMP"              , "TIMESTAMP({S}) "                  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9,  -1,  -1),
	...
	TIME_TZ_UNCONSTRAINED     ("TIME TZ UNCONSTRAINED"     ,StandardTypeMetadata.TIMESTAMP             , "TIMESTAMP"              , "TIMESTAMP({S}) {Z}"               , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9,   1,  -1),
	TIME_UNCONSTRAINED        ("TIME_UNCONSTRAINED"        ,StandardTypeMetadata.TIMESTAMP             , "TIMESTAMP"              , "TIMESTAMP({S}) "                  , null   , null   , null   ,   1,   2,   1,  -1,  -1,   9,  -1,  -1),
	TIMESTAMP_NTZ             ("TIMESTAMP_NTZ"             ,StandardTypeMetadata.TIMESTAMP             ,   1,   2,   1,  -1,  -1,   9,  -1,  -1),
	...
	VARCHAR                   ("VARCHAR"                   ,StandardTypeMetadata.VARCHAR2              ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	OracleGenusTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
		this.input = input;
	...
	OracleGenusTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
		this.standard = standard;
		this.meta = meta;
		this.formula = formula;
	...
	OracleGenusTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}

	OracleGenusTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {

...
public class TransferBank {
	...
	protected String partner_trade_no	;//商户企业付款单号		是	1212121221227	string(32)	商户订单号，需保持唯一（只允许数字[0~9]或字母[A~Z]和[a~z]，最短8位，最长32位）
	...
	protected String amount				;//付款金额			是	100000	int	付款金额：RMB分（支付总额，不含手续费） 注：大于0的整数

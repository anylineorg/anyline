...
public class Transfer {
	...
	protected String partner_trade_no	;// 商户订单号			是	10000098201411111234567890	String(32)	商户订单号，需保持唯一性(只能是字母或者数字，不能包含有其他字符)
	protected String openid				;// 用户openid		是	oxTWIuGaIt6gTKsQRLau2M0yL16E	String(64)	商户appid下，某用户的openid
	protected String check_name			;// 校验用户姓名选项	是	FORCE_CHECK	String(16)	NO_CHECK：不校验真实姓名  FORCE_CHECK：强校验真实姓名
	protected String re_user_name		;// 收款用户姓名		可选	王小王	String(64)	收款用户真实姓名。 如果check_name设置为FORCE_CHECK，则必填用户真实姓名
	protected String amount				;// 金额				是	10099	int	企业付款金额，单位为分

...
public class QQMPUtil {
	...
	public DataRow getOpenId(String code){
		...
		//1.获取accesstoken
		String url = "https://graph.qq.com/oauth2.0/token?grant_type=authorization_code&client_id=" + config.APP_ID+"&client_secret="+config.APP_SECRECT+"&code="+code+"&state=a&redirect_uri="+redirect;

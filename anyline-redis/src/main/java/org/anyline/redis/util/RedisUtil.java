...
//	private static final String orgName = RedisConfig.ORG_NAME;
//	private static final String appName = RedisConfig.APP_NAME;
//	private static final String clientId= RedisConfig.CLIENT_ID;
//	private static final String clientSecret = RedisConfig.CLIENT_SECRET;
//	private static final String host = RedisConfig.HOST;
//	
	...
	public static RedisUtil getInstance(String key){
		...
		if(null == util){
			util = new RedisUtil();
			RedisConfig config = RedisConfig.getInstance(key);
			util.config = config;

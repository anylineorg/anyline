...
@AnylineComponent("anyline.data.adapter.vearch")
public class VearchAdapter extends AbstractDriverAdapter {
    @Override
    public DatabaseType type() {
        return DatabaseType.vearch;
    }

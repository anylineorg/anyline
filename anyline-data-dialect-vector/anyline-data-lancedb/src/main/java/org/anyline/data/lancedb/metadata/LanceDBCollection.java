...
public class LanceDBCollection extends Table<LanceDBCollection> {
    protected String keyword = "table";
    protected LanceDBSchema schema = new LanceDBSchema();
    public String keyword(){
        return this.keyword;
    }
    public void schema(LanceDBSchema schema){
        this.schema = schema;
    }
    public LanceDBSchema schema(){
        return schema;
    }

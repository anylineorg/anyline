...
package org.anyline.data.lancedb.metadata;
...
public class LanceDBSchema extends Metadata<LanceDBSchema> {
    ...
    public LanceDBSchema addColumn(LinkedHashMap<String, Column> columns) {
        this.columns.putAll(columns);
        return this;
    }
    public LanceDBSchema addColumn(Column column) {

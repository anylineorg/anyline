...
public class ChromaRuntime extends AbstractRuntime implements DataRuntime {

    protected Object client;

    public ChromaRuntime() {
    }
    ...
    public ChromaRuntime(String key, Object client, DriverAdapter adapter) {
        setKey(key);
        setProcessor(client);
        setAdapter(adapter);
    }

...
public enum TDengineTypeMetadataAlias implements TypeMetadataAlias {
	...
	CHAR                          ("CHAR"                           ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	...
	DATEV2                        ("DATEV2"                         ,StandardTypeMetadata.TIMESTAMP                     ,   1,   2,   1),
	...
	LONGTEXT                      ("LONGTEXT"                       ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	...
	MEDIUMTEXT                    ("MEDIUMTEXT"                     ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	...
	NCLOB                         ("NCLOB"                          ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	NESTED                        ("nested"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	NTEXT                         ("NTEXT"                          ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	...
	NVARCHAR                      ("NVARCHAR"                       ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	NVARCHAR2                     ("NVARCHAR2"                      ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	...
	TEXT                          ("TEXT"                           ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	...
	TINYTEXT                      ("TINYTEXT"                       ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	...
	VARCHAR                       ("VARCHAR"                        ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	VARCHAR2                      ("VARCHAR2"                       ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),
	...
	XML                           ("XML"                            ,StandardTypeMetadata.NCHAR                         ,   0,   1,   1),

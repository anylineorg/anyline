...
public enum TDengineTypeMetadataAlias implements TypeMetadataAlias {
	...
	BIT                       ("BIT"                       ,StandardTypeMetadata.BOOL        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	CHAR                      ("CHAR"                      ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	DATE                      ("DATE"                      ,StandardTypeMetadata.TIMESTAMP   ,   1,   1,   2,  -1,  -1,  -1,  -1,  -1),
	...
	DATEV2                    ("DATEV2"                    ,StandardTypeMetadata.TIMESTAMP   ,   1,   2,   1,  -1,  -1,  -1,  -1,  -1),
	...
	LONGTEXT                  ("LONGTEXT"                  ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	MEDIUMTEXT                ("MEDIUMTEXT"                ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	NCLOB                     ("NCLOB"                     ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	NESTED                    ("nested"                    ,StandardTypeMetadata.NONE        ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	NTEXT                     ("NTEXT"                     ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	NVARCHAR                  ("NVARCHAR"                  ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	NVARCHAR2                 ("NVARCHAR2"                 ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TEXT                      ("TEXT"                      ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TID                       ("TID"                       ,StandardTypeMetadata.NONE        ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	TIME                      ("TIME"                      ,StandardTypeMetadata.TIMESTAMP   ,   1,   1,   2,  -1,  -1,  -1,  -1,  -1),
	...
	TIMEZ                     ("TIMEZ"                     ,StandardTypeMetadata.TIMESTAMP   ,   1,   1,   2,  -1,  -1,  -1,  -1,  -1),
	...
	TINYTEXT                  ("TINYTEXT"                  ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	VARCHAR                   ("VARCHAR"                   ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	VARCHAR2                  ("VARCHAR2"                  ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	XML                       ("XML"                       ,StandardTypeMetadata.NCHAR       ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TDengineTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
		this.input = input;
	...
	TDengineTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
		this.standard = standard;
		this.meta = meta;
		this.formula = formula;
	...
	TDengineTypeMetadataAlias(String input, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null , null, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	TDengineTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}

	TDengineTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
	...
	TDengineTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, meta, formula, null, null, null, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	TDengineTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale) {
	...
	TDengineTypeMetadataAlias(String input, TypeMetadata standard) {
		this.input = input;
		this.standard = standard;
	}

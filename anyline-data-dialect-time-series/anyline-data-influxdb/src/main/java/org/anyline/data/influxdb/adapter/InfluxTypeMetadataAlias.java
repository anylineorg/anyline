...
public enum InfluxTypeMetadataAlias implements TypeMetadataAlias {
	...
	DURATION                      ("DURATION"                       ,StandardTypeMetadata.DURATION                      ,   1,   1,   1),
	FIXED_STRING                  ("FIXED_STRING"                   ,StandardTypeMetadata.FIXED_STRING                  , "FIXED_STRING" , "FIXED_STRING"  , null   , null   , null   ,   0,   1,   1),
	FLOAT                         ("FLOAT"                          ,StandardTypeMetadata.FLOAT                         ,   1,   1,   1),
	INT                           ("INT"                            ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	INT16                         ("INT16"                          ,StandardTypeMetadata.INT16                         ,   1,   1,   1),
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP                     ,   1,   2,   2),
	...
	ARRAY                         ("ARRAY"                          ,StandardTypeMetadata.LIST                          ,   1,   1,   1),
	...
	FIXEDSTRING                   ("FixedString"                    ,StandardTypeMetadata.FIXED_STRING                  , "FIXED_STRING" , "FIXED_STRING"  , null   , null   , null   ,   0,   1,   1),
	...
	INT128                        ("INT128"                         ,StandardTypeMetadata.INT64                         ,   1,   1,   1),
	...
	INT256                        ("INT256"                         ,StandardTypeMetadata.INT64                         ,   1,   1,   1),
	...
	JSONB                         ("JSONB"                          ,StandardTypeMetadata.STRING                        ,   1,   1,   1),
	JSONPATH                      ("JSONPATH"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	KEYWORD                       ("KEYWORD"                        ,StandardTypeMetadata.STRING                        ,   1,   1,   1),
	...
	NCHAR                         ("NCHAR"                          ,StandardTypeMetadata.FIXED_STRING                  ,   0,   1,   1),
	...
	SHORT                         ("SHORT"                          ,StandardTypeMetadata.INT16                         ,   1,   1,   1),
	...
	SMALLDECIMAL                  ("SMALLDECIMAL"                   ,StandardTypeMetadata.DOUBLE                        ,   1,   0,   0),
	SMALLFLOAT                    ("SMALLFLOAT"                     ,StandardTypeMetadata.FLOAT                         ,   1,   2,   3),
	SMALLINT                      ("SMALLINT"                       ,StandardTypeMetadata.INT16                         ,   1,   1,   1),
	SMALLMONEY                    ("SMALLMONEY"                     ,StandardTypeMetadata.DOUBLE                        ,   1,   0,   0),
	SMALLSERIAL                   ("SMALLSERIAL"                    ,StandardTypeMetadata.INT16                         ,   1,   1,   1),
	...
	ST_POINT                      ("ST_POINT"                       ,StandardTypeMetadata.POINT                         ,   1,   1,   1),
	...
	TIME_TZ_UNCONSTRAINED         ("TIME TZ UNCONSTRAINED"          ,StandardTypeMetadata.TIME                          ,   1,   1,   1),
	...
	TIME_UNCONSTRAINED            ("TIME_UNCONSTRAINED"             ,StandardTypeMetadata.TIME                          ,   1,   1,   1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP                     ,   1,   2,   2),
	...
	TINYINT                       ("TINYINT"                        ,StandardTypeMetadata.INT8                          ,   1,   1,   1),
	...
	InfluxTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this.input = input;
	...
	InfluxTypeMetadataAlias(String input, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null , null, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale);
	}

	InfluxTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, meta, formula, null, null, null, ignoreLength, ignorePrecision, ignoreScale);
	}

	InfluxTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null, null, null, ignoreLength, ignorePrecision, ignoreScale);
	}

	InfluxTypeMetadataAlias(TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(null, standard, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale);
	}

	InfluxTypeMetadataAlias(String input, TypeMetadata standard) {
		this.input = input;
		this.standard = standard;
	}

	InfluxTypeMetadataAlias(TypeMetadata standard) {
		this.standard = standard;
	}

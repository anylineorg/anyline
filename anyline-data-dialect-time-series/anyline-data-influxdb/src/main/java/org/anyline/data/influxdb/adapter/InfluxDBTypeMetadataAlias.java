...
public enum InfluxDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	UINT128                       ("UInt128"                        ,StandardTypeMetadata.INT32                         , "integer"  , "INT"      , null   , null   , null   ,   1,   1,   1),
	UINT16                        ("UInt16"                         ,StandardTypeMetadata.INT32                         , "integer"  , "INT"      , null   , null   , null   ,   1,   1,   1),
	UINT256                       ("UInt256"                        ,StandardTypeMetadata.INT32                         , "integer"  , "INT"      , null   , null   , null   ,   1,   1,   1),
	UINT32                        ("UInt32"                         ,StandardTypeMetadata.INT32                         , "integer"  , "INT"      , null   , null   , null   ,   1,   1,   1),
	UINT64                        ("UInt64"                         ,StandardTypeMetadata.INT32                         , "integer"  , "INT"      , null   , null   , null   ,   1,   1,   1),
	UINT8                         ("UInt8"                          ,StandardTypeMetadata.INT32                         , "integer"  , "INT"      , null   , null   , null   ,   1,   1,   1),

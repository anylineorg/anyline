...
package org.anyline.data.coze.run;
...
public class CozeRun extends TableRun implements Run {
    ...
    public CozeRun(DataRuntime runtime) {
        super(runtime, (Table)null);
    }

    public CozeRun(DataRuntime runtime, String table) {
        super(runtime, table);
    }

    public CozeRun(DataRuntime runtime, Table table) {
        super(runtime, table);
    }

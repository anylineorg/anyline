...
public interface Regular {
	...
	public static enum PATTERN{
		...
		*/
		...
		,DATE_TIME{
			public String getName(){return "日期时间或时间";}
			public String getCode(){return "((?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)-02-29))?(20|21|22|23|[0-1]\\d):[0-5]\\d(:[0-5]\\d(.\\d{1,3})?)?";}
		}
		/**   
		* 匹配电话 

 ...
 *
 * Licensed under the Apache License, Version 2.0 (DataRuntime runtime, String random, the "License"){return SWITCH.CONTINUE;}
...
public interface DMListener {
     ...
     * @return SWITCH
     */
    default SWITCH  beforeInsert(DataRuntime runtime, String random, Run run, String dest, Object obj, boolean checkPrimary, List<String> columns){return SWITCH.CONTINUE;}

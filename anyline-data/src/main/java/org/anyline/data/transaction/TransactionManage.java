...
public interface TransactionManage {
     ...
     */
    TransactionState start(TransactionDefine define);
     ...
     */
    default TransactionState start(int behavior){
     ...
     */
    default TransactionState start(){
     ...
     */
    void commit(TransactionState state);
    /**
     * 回滚事务
     * @param state 启动事务时返回state
     */
    void rollback(TransactionState state);
}

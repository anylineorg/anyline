...
public class Select {
    ...
    public static Select parse(String sql) {
        ...
        //UNION
        //SELECT ID, NAME FROM USER UNION ALL SELECT ID , NAME FROM hr_usr
        //子查询union
        //SELECT * FROM (SELECT ID, NAME FROM USER UNION ALL SELECT ID , NAME FROM hr_usr) AS M WHERE ID &gt; 0

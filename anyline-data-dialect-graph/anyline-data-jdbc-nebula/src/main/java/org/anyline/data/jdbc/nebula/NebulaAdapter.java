...
package org.anyline.data.jdbc.nebula;
...
import java.util.*;
@Component("anyline.data.jdbc.adapter.nebula")
public class NebulaAdapter extends AbstractJDBCAdapter implements JDBCAdapter {

...
public class NebulaRuntimeHolder extends AbstractRuntimeHolder {
    private static final NebulaRuntimeHolder instance = new NebulaRuntimeHolder();
    public static NebulaRuntimeHolder instance() {
        return instance;
    }
     ...
     * @param datasource 数据源, nebulaDatabase, nebulaClient
     * @param database 数据库, nebula类型数据源不需要
    ...
    public DataRuntime temporary(Object datasource, String database, DriverAdapter adapter) throws Exception {
        ...
        if(datasource instanceof SessionPool) {
            ...
            throw new Exception("请提供 com.vesoft.nebula.client.graph.SessionPool 兼容类型");
        }

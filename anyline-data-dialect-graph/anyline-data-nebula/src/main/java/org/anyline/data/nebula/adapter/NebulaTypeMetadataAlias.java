...
public enum NebulaTypeMetadataAlias implements TypeMetadataAlias {
	...
	DURATION                  ("DURATION"                  ,StandardTypeMetadata.DURATION       ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	FIXED_STRING              ("FIXED_STRING"              ,StandardTypeMetadata.FIXED_STRING   , "FIXED_STRING" , "FIXED_STRING"  , null   , null   , null   ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	INT16                     ("INT16"                     ,StandardTypeMetadata.INT16          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT32                     ("INT32"                     ,StandardTypeMetadata.INT32          , "INT"          , "INT"           , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT64                     ("INT64"                     ,StandardTypeMetadata.INT64          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT8                      ("INT8"                      ,StandardTypeMetadata.INT8           ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TIMESTAMP                 ("TIMESTAMP"                 ,StandardTypeMetadata.TIMESTAMP      ,   1,   2,   2,  -1,  -1,  -1,  -1,  -1),
	...
	ARRAY                     ("ARRAY"                     ,StandardTypeMetadata.LIST           ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	DECIMAL                   ("DECIMAL"                   ,StandardTypeMetadata.DOUBLE         ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	...
	DOUBLE_PRECISION          ("DOUBLE PRECISION"          ,StandardTypeMetadata.DOUBLE         ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	DSINTERVAL                ("DSINTERVAL"                ,StandardTypeMetadata.NONE           ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	ENUM                      ("ENUM"                      ,StandardTypeMetadata.NONE           ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	FIXEDSTRING               ("FixedString"               ,StandardTypeMetadata.FIXED_STRING   , "FIXED_STRING" , "FIXED_STRING"  , null   , null   , null   ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	INT128                    ("INT128"                    ,StandardTypeMetadata.INT64          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT2                      ("INT2"                      ,StandardTypeMetadata.INT32          , "INT"          , "INT"           , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT256                    ("INT256"                    ,StandardTypeMetadata.INT64          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	JSONB                     ("JSONB"                     ,StandardTypeMetadata.STRING         ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	JSONPATH                  ("JSONPATH"                  ,StandardTypeMetadata.NONE           ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	KEYWORD                   ("KEYWORD"                   ,StandardTypeMetadata.STRING         ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	LARGEINT                  ("LARGEINT"                  ,StandardTypeMetadata.STRING         ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	MEDIUMINT                 ("MEDIUMINT"                 ,StandardTypeMetadata.INT8           ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	NCHAR                     ("NCHAR"                     ,StandardTypeMetadata.FIXED_STRING   ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	NUMBER                    ("NUMBER"                    ,StandardTypeMetadata.DOUBLE         ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	...
	SHORT                     ("SHORT"                     ,StandardTypeMetadata.INT16          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SMALLDECIMAL              ("SMALLDECIMAL"              ,StandardTypeMetadata.DOUBLE         ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	SMALLFLOAT                ("SMALLFLOAT"                ,StandardTypeMetadata.FLOAT          ,   1,   2,   3,  -1,  -1,  -1,  -1,  -1),
	SMALLINT                  ("SMALLINT"                  ,StandardTypeMetadata.INT16          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	SMALLMONEY                ("SMALLMONEY"                ,StandardTypeMetadata.DOUBLE         ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	SMALLSERIAL               ("SMALLSERIAL"               ,StandardTypeMetadata.INT16          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	ST_POINT                  ("ST_POINT"                  ,StandardTypeMetadata.POINT          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TIME_TZ_UNCONSTRAINED     ("TIME TZ UNCONSTRAINED"     ,StandardTypeMetadata.TIME           ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TIME_UNCONSTRAINED        ("TIME_UNCONSTRAINED"        ,StandardTypeMetadata.TIME           ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMP_NTZ             ("TIMESTAMP_NTZ"             ,StandardTypeMetadata.TIMESTAMP      ,   1,   2,   1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMPTZ               ("TIMESTAMPTZ"               ,StandardTypeMetadata.TIMESTAMP      ,   1,   2,   2,  -1,  -1,  -1,  -1,  -1),
	...
	NebulaTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
		this.input = input;
	...
	NebulaTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
		this.standard = standard;
		this.meta = meta;
		this.formula = formula;
	...
	NebulaTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}

	NebulaTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {

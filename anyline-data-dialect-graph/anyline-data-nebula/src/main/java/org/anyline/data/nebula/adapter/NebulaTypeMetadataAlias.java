...
public enum NebulaTypeMetadataAlias implements TypeMetadataAlias {
	...
	FIXED_STRING                  ("FIXED_STRING"                   ,StandardTypeMetadata.FIXED_STRING                  , "FIXED_STRING" , null   , null   , null   , null   ,   0,   1,   1),
	...
	BINARY_INTEGER                ("BINARY_INTEGER"                 ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	...
	BPCHAR                        ("BPCHAR"                         ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	BPCHARBYTE                    ("BPCHARBYTE"                     ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	BYTE                          ("BYTE"                           ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	...
	CLICKHOUSE_DATETIME64         ("DATETIME64"                     ,StandardTypeMetadata.DATETIME                      ,   1,   1,   1),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	...
	DSINTERVAL                    ("DSINTERVAL"                     ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	ENUM                          ("ENUM"                           ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	FIXEDSTRING                   ("FixedString"                    ,StandardTypeMetadata.FIXED_STRING                  , "FIXED_STRING" , null   , null   , null   , null   ,   0,   1,   1),
	...
	CLICKHOUSE_INT16              ("INT16"                          ,StandardTypeMetadata.INT16                         ,   1,   1,   1),
	...
	CLICKHOUSE_INT8               ("INT8"                           ,StandardTypeMetadata.INT8                          ,   1,   1,   1),
	...
	INTERVAL_DAY_SECOND           ("INTERVAL DAY TO SECOND"         ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	...
	INTERVAL_YEAR_MONTH           ("INTERVAL YEAR TO MONTH"         ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	...
	SIMPLE_INTEGER                ("SIMPLE_INTEGER"                 ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	...
	CLICKHOUSE_UINT16             ("UINT16"                         ,StandardTypeMetadata.INT16                         ,   1,   1,   1),
	CLICKHOUSE_UINT256            ("UINT256"                        ,StandardTypeMetadata.INT64                         ,   1,   1,   1),
	CLICKHOUSE_UINT32             ("UINT32"                         ,StandardTypeMetadata.INT32                         ,   1,   1,   1),
	CLICKHOUSE_UINT64             ("UINT64"                         ,StandardTypeMetadata.INT64                         ,   1,   1,   1),
	CLICKHOUSE_UINT8              ("UINT8"                          ,StandardTypeMetadata.INT8                          ,   1,   1,   1),

...
public interface SystemFunction {    enum META{
        ABS("绝对值"),
        ...
        CONVERT("将值强制转换为特定类型"),
        CONVERT_DBID_TO_ID(""),
        CONVERT_FROM("将表示编码src_encoding文本的二进制字符串转换为数据库编码中的文本"),
        CONVERT_GUID_TO_ID(""),
        CONVERT_NAME_TO_ID(""),
        ...
        EXTRACT_VALUE("使用 XPath 表示法从 XML 字符串中提取值"),
        FACTORIAL("阶乘"),
        ...
        FIELD("一个值(value)在给定列表(val1, val2, ...)中第一次出现的索引"),
        ...
        GET_DATE_TIME_FORMAT("日期或时间格式字符串"),
        ...
        INSERT("在指定位置插入子字符串"),
        INSERT_TEXT("用一个字符串替换另一个字符串中指定位置指定长度的子串"),
        INSERT_TEXT_C("从指定的位置，删除指定的长度，再加入指定的字符串"),
        INSTR("第一次出现的子字符串的索引"),
        ...
        QUOTE("转义"),
        QUOTE_IDENT("输出字符串表达式"),
        QUOTE_LITERAL("输出字符串表达式"),
        QUOTE_NULLABLE("输出字符串表达式"),
        RADIANS("转换为弧度"),
        RADIUS("计算圆的半径"),
        RAND("随机浮点值"),
        RANDOM("随机浮点值"),

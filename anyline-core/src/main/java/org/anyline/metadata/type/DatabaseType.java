...
public enum DatabaseType implements Serializable {
        ...
        GBase8A             	("南大通用"                             	,KEY_CASE.SRC	,990	,null	,"com.gbase.jdbc.Driver"	,"jdbc:gbase://{host}:{port:5258}/{database}"),
        GBase8C             	("南大通用"                             	,KEY_CASE.SRC	,990	,null	,"com.gbase.jdbc.Driver"	,"jdbc:gbase://{host}:{port:5258}/{database}"),
        GBase8S             	("南大通用"                             	,KEY_CASE.SRC	,990	,null	,"com.gbase.jdbc.Driver"	,"jdbc:gbasedbt-sqli://{host}:{port:1533}/{database}:GBASEDBTSERVER={server};user={user};password={password}"),

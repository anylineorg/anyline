...
public class ConfigTable {
	...
	protected static final String version 				= "9.7.5-jdk17-20260805"	;	// 版本号
	...
	//补充数据类型、系统函数、属性等配置(如果不需要同步，可以把这一项设置成null)
	public static String METADATA_CONFIG_SYNC_HOST						= "https://meta.anyline.org";
	...
	public static boolean IS_ENABLE_COLUMN_POSITION						= false			;	// 是否开启通用的position(仅支持部分标准SQL)遇到没有实现adapter的数据库时可以开启
	...
	public static int SQL_SELECT_TIMEOUT 								= -1			;	// 等待 查询SQL 语句完成的最大时间(s), 超过则抛出异常
	...
	public static DatabaseType DEFAULT_DIALECT_DATABASE					= null			;	// 默认的语法对应数据库(执行函数转换时参考)

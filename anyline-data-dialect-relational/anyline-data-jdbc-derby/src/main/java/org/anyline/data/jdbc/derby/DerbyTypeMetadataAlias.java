...
public enum DerbyTypeMetadataAlias implements TypeMetadataAlias {
	...
	BIT                           ("BIT"                            ,StandardTypeMetadata.SMALLINT                      ,   1,   1,   1),
	...
	LONGBLOB                      ("LONGBLOB"                       ,StandardTypeMetadata.CLOB                          ,   1,   1,   1),
	...
	MEDIUMTEXT                    ("MEDIUMTEXT"                     ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	...
	SERIAL                        ("SERIAL"                         ,StandardTypeMetadata.SMALLINT                      ,   1,   1,   1),
	...
	VARBINARY                     ("VARBINARY"                      ,StandardTypeMetadata.CLOB                          ,   1,   1,   1),
	VARBIT                        ("VARBIT"                         ,StandardTypeMetadata.CLOB                          ,   1,   1,   1),
	...
	XML                           ("XML"                            ,StandardTypeMetadata.CLOB                          ,   1,   1,   1),
	...
	DerbyTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale){
		this.input = input;

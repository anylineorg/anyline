...
public enum GBase8sTypeMetadataAlias implements TypeMetadataAlias {
	...
	BINARY_FLOAT              ("BINARY_FLOAT"              ,StandardTypeMetadata.BINARY_FLOAT    ,   1,   2,   3,  -1,  -1,  -1,  -1,  -1),
	BLOB                      ("BLOB"                      ,StandardTypeMetadata.BLOB            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	BOOLEAN                   ("BOOLEAN"                   ,StandardTypeMetadata.BOOLEAN         ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	BYTE                      ("BYTE"                      ,StandardTypeMetadata.BYTE            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	DATETIME                  ("DATETIME"                  ,StandardTypeMetadata.DATETIME        , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1,  -1,  -1),
	DECIMAL                   ("DECIMAL"                   ,StandardTypeMetadata.DECIMAL         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	DOUBLE                    ("DOUBLE"                    ,StandardTypeMetadata.DECIMAL         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	...
	LVARCHAR                  ("LVARCHAR"                  ,StandardTypeMetadata.LVARCHAR        ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SMALLFLOAT                ("SMALLFLOAT"                ,StandardTypeMetadata.SMALLFLOAT      ,   1,   2,   3,  -1,  -1,  -1,  -1,  -1),
	...
	BINARY                    ("BINARY"                    ,StandardTypeMetadata.BYTE            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	BIT                       ("BIT"                       ,StandardTypeMetadata.BYTE            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	DEC                       ("DEC"                       ,StandardTypeMetadata.DECIMAL         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	DECFLOAT                  ("DECFLOAT"                  ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	DECIMAL128                ("Decimal128"                ,StandardTypeMetadata.DECIMAL         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	DECIMAL256                ("Decimal256"                ,StandardTypeMetadata.DECIMAL         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	DECIMAL32                 ("Decimal32"                 ,StandardTypeMetadata.DECIMAL         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	DECIMAL64                 ("Decimal64"                 ,StandardTypeMetadata.DECIMAL         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	...
	IMAGE                     ("IMAGE"                     ,StandardTypeMetadata.BYTE            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	JSON                      ("JSON"                      ,StandardTypeMetadata.TEXT            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	JSONB                     ("JSONB"                     ,StandardTypeMetadata.TEXT            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	NUMBER                    ("NUMBER"                    ,StandardTypeMetadata.DECIMAL         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	NUMERIC                   ("NUMERIC"                   ,StandardTypeMetadata.NUMERIC         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	...
	REAL                      ("REAL"                      ,StandardTypeMetadata.FLOAT           ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SERIAL2                   ("SERIAL2"                   ,StandardTypeMetadata.SERIAL          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	SERIAL4                   ("SERIAL4"                   ,StandardTypeMetadata.SERIAL          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SMALLDECIMAL              ("SMALLDECIMAL"              ,StandardTypeMetadata.DECIMAL         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	SMALLINT                  ("SMALLINT"                  ,StandardTypeMetadata.INT32           , "INT"      , "INT"           , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	SMALLMONEY                ("SMALLMONEY"                ,StandardTypeMetadata.DECIMAL         ,   1,   0,   2,  -1,  -1,  -1,  -1,  -1),
	SMALLSERIAL               ("SMALLSERIAL"               ,StandardTypeMetadata.SERIAL          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TINYBLOB                  ("TINYBLOB"                  ,StandardTypeMetadata.BYTE            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TINYINT                   ("TINYINT"                   ,StandardTypeMetadata.INT32           , "INT"      , "INT"           , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	VARBINARY                 ("VARBINARY"                 ,StandardTypeMetadata.BYTE            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	VARBIT                    ("VARBIT"                    ,StandardTypeMetadata.BYTEA           ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	YEAR                      ("YEAR"                      ,StandardTypeMetadata.DATETIME        , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1,  -1,  -1),
	...
	GBase8sTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
		this.input = input;
	...
	GBase8sTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
		this.standard = standard;
		this.meta = meta;
		this.formula = formula;
	...
	GBase8sTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}

	GBase8sTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {

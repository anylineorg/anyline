...
public enum VoltDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	CHAR                               ("CHAR"                             ,StandardTypeMetadata.VARCHAR                            , 0, 1, 1),
	...
	DATE                               ("DATE"                             ,StandardTypeMetadata.TIMESTAMP                          , 1, 1, 1),
	...
	YEAR                               ("YEAR"                             ,StandardTypeMetadata.TIMESTAMP                          , 1, 1, 1),
	...
	VoltDBTypeMetadataAlias(String compatible, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale){
	...
	VoltDBTypeMetadataAlias(String compatible, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale){
	...
	VoltDBTypeMetadataAlias(String compatible, TypeMetadata standard){
		this.compatible = compatible;
		this.standard = standard;
	}

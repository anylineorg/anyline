...
public enum VoltDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	GEOGRAPHY_POINT               ("GEOGRAPHY_POINT"                ,StandardTypeMetadata.GEOGRAPHY_POINT               ,   1,   1,   1),
	...
	BINARY                        ("BINARY"                         ,StandardTypeMetadata.VARBINARY                     ,   0,   1,   1),
	...
	BOOL                          ("BOOL"                           ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1),
	...
	CHAR                          ("CHAR"                           ,StandardTypeMetadata.VARCHAR                       , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,   0,   1,   1),
	...
	DATE                          ("DATE"                           ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   2),
	...
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.TIMESTAMP                     , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   2),
	...
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.TIMESTAMP                     , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   2),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.TIMESTAMP                     , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   2),
	...
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.DECIMAL                       , null       , null            , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,   1,   0,   0),
	...
	GEOMETRY                      ("GEOMETRY"                       ,StandardTypeMetadata.GEOGRAPHY                     ,   1,   1,   1),
	GEOMETRYCOLLECTION            ("GEOMETRYCOLLECTION"             ,StandardTypeMetadata.GEOGRAPHY                     ,   1,   1,   1),
	...
	IMAGE                         ("IMAGE"                          ,StandardTypeMetadata.VARBINARY                     ,   0,   1,   1),
	INET                          ("INET"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	INT                           ("INT"                            ,StandardTypeMetadata.INTEGER                       , null       , null            , null                       , "NUMERIC_PRECISION"  , null            ,   1,   1,   1),
	...
	JSON                          ("JSON"                           ,StandardTypeMetadata.VARCHAR                       ,   0,   1,   1),
	JSONB                         ("JSONB"                          ,StandardTypeMetadata.VARBINARY                     ,   0,   1,   1),
	...
	LINE                          ("LINE"                           ,StandardTypeMetadata.GEOGRAPHY                     ,   1,   1,   1),
	LINESTRING                    ("LINESTRING"                     ,StandardTypeMetadata.GEOGRAPHY                     ,   1,   1,   1),
	...
	MEDIUMBLOB                    ("MEDIUMBLOB"                     ,StandardTypeMetadata.GEOGRAPHY                     ,   1,   1,   1),
	MEDIUMINT                     ("MEDIUMINT"                      ,StandardTypeMetadata.GEOGRAPHY                     ,   1,   1,   1),
	MEDIUMTEXT                    ("MEDIUMTEXT"                     ,StandardTypeMetadata.GEOGRAPHY                     ,   1,   1,   1),
	MONEY                         ("MONEY"                          ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   0),
	MULTILINESTRING               ("MULTILINESTRING"                ,StandardTypeMetadata.GEOGRAPHY                     ,   1,   1,   1),
	MULTIPOINT                    ("MULTIPOINT"                     ,StandardTypeMetadata.GEOGRAPHY                     ,   1,   1,   1),
	MULTIPOLYGON                  ("MULTIPOLYGON"                   ,StandardTypeMetadata.GEOGRAPHY                     ,   1,   1,   1),
	...
	POINT                         ("POINT"                          ,StandardTypeMetadata.GEOGRAPHY_POINT               ,   1,   1,   1),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.TIMESTAMP                     , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   2),
	...
	YEAR                          ("YEAR"                           ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   2),

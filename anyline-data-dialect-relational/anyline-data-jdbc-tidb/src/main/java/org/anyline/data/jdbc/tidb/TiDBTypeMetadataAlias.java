...
public enum TiDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.DATETIME2                     ,   1,   1,   1),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.DATETIMEOFFSET                ,   1,   1,   1),
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP                     , null   , null   , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1),
	...
	CLICKHOUSE_DECIMAL128         ("DECIMAL128"                     ,StandardTypeMetadata.NONE                          , null   , null   , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,  -1,  -1,  -1),
	CLICKHOUSE_DECIMAL256         ("DECIMAL256"                     ,StandardTypeMetadata.NONE                          , null   , null   , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,  -1,  -1,  -1),
	CLICKHOUSE_DECIMAL32          ("DECIMAL32"                      ,StandardTypeMetadata.NONE                          , null   , null   , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,  -1,  -1,  -1),
	CLICKHOUSE_DECIMAL64          ("DECIMAL64"                      ,StandardTypeMetadata.NONE                          , null   , null   , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,  -1,  -1,  -1),
	...
	INTERVAL                      ("INTERVAL"                       ,StandardTypeMetadata.ILLEGAL                       , null   , null   , null                       , "DATETIME_PRECISION" , null            ,  -1,  -1,  -1),
	...
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP                     , null   , null   , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP                     , null   , null   , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , null   , null   , null                       , "DATETIME_PRECISION" , null            ,   1,   2,   1),
	...
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.TIMESTAMP                     , null   , null   , null                       , "DATETIME_PRECISION" , null            ,   1,  -1,  -1),
	...
	TiDBTypeMetadataAlias(String input, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale){
		this(input, standard, null , null, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale);
	}

	TiDBTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, int ignoreLength, int ignorePrecision, int ignoreScale){
		this(input, standard, meta, formula, null, null, null, ignoreLength, ignorePrecision, ignoreScale);
	}

	TiDBTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale){
	...
	TiDBTypeMetadataAlias(String input, TypeMetadata standard){
		this.input = input;
		this.standard = standard;
	}

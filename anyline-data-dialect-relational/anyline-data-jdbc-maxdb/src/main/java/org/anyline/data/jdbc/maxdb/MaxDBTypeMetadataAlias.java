...
public enum MaxDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	BIGINT                        ("BIGINT"                         ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1),
	BIGSERIAL                     ("BIGSERIAL"                      ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1),
	...
	INT8                          ("INT8"                           ,StandardTypeMetadata.INT32                         , "INT"  , "INT"  , null   , null   , null   ,   1,   2,   1),
	...
	SERIAL8                       ("SERIAL8"                        ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1),
	SET                           ("SET"                            ,StandardTypeMetadata.INT32                         , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	...
	MaxDBTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this.input = input;

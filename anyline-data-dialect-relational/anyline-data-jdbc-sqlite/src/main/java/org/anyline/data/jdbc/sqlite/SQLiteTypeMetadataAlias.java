...
public enum SQLiteTypeMetadataAlias implements TypeMetadataAlias {
	...
	BIGINT                    ("BIGINT"                    ,StandardTypeMetadata.INTEGER     ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	BIGSERIAL                 ("BIGSERIAL"                 ,StandardTypeMetadata.INTEGER     ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	BINARY                    ("BINARY"                    ,StandardTypeMetadata.BLOB        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	BINARY_DOUBLE             ("BINARY_DOUBLE"             ,StandardTypeMetadata.REAL        ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	...
	CHAR                      ("CHAR"                      ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	CIRCLE                    ("CIRCLE"                    ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	DATETIME                  ("DATETIME"                  ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	DATETIME2                 ("DATETIME2"                 ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	DATETIMEOFFSET            ("DATETIMEOFFSET"            ,StandardTypeMetadata.INTEGER     ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	DATETIMEV2                ("DATETIMEV2"                ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	DECIMAL                   ("DECIMAL"                   ,StandardTypeMetadata.REAL        ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	...
	DOUBLE                    ("DOUBLE"                    ,StandardTypeMetadata.REAL        ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	...
	GEOMETRY                  ("GEOMETRY"                  ,StandardTypeMetadata.REAL        ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	...
	MONEY                     ("MONEY"                     ,StandardTypeMetadata.REAL        ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	...
	NCHAR                     ("NCHAR"                     ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	NCLOB                     ("NCLOB"                     ,StandardTypeMetadata.BLOB        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	NESTED                    ("nested"                    ,StandardTypeMetadata.NONE        ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	NTEXT                     ("NTEXT"                     ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	NUMBER                    ("NUMBER"                    ,StandardTypeMetadata.REAL        ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	NUMERIC                   ("NUMERIC"                   ,StandardTypeMetadata.REAL        ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	NUMRANGE                  ("NUMRANGE"                  ,StandardTypeMetadata.NONE        ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	NVARCHAR                  ("NVARCHAR"                  ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	NVARCHAR2                 ("NVARCHAR2"                 ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SMALLDATETIME             ("SMALLDATETIME"             ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SMALLINT                  ("SMALLINT"                  ,StandardTypeMetadata.INTEGER     ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	SMALLMONEY                ("SMALLMONEY"                ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TIME                      ("TIME"                      ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TIMESTAMP                 ("TIMESTAMP"                 ,StandardTypeMetadata.INTEGER     ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TIMEZ                     ("TIMEZ"                     ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TINYBLOB                  ("TINYBLOB"                  ,StandardTypeMetadata.BLOB        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TINYINT                   ("TINYINT"                   ,StandardTypeMetadata.INTEGER     ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	UINT128                   ("UInt128"                   ,StandardTypeMetadata.INT128      ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	UINT16                    ("UInt16"                    ,StandardTypeMetadata.INT16       ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	UINT8                     ("UInt8"                     ,StandardTypeMetadata.INTEGER     ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	VARCHAR                   ("VARCHAR"                   ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	VARCHAR2                  ("VARCHAR2"                  ,StandardTypeMetadata.TEXT        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SQLiteTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
		this.input = input;
	...
	SQLiteTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
		this.standard = standard;
		this.meta = meta;
		this.formula = formula;
	...
	SQLiteTypeMetadataAlias(String input, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null , null, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	SQLiteTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}

	SQLiteTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
	...
	SQLiteTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, meta, formula, null, null, null, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	SQLiteTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale) {
	...
	SQLiteTypeMetadataAlias(String input, TypeMetadata standard) {
		this.input = input;
		this.standard = standard;
	}

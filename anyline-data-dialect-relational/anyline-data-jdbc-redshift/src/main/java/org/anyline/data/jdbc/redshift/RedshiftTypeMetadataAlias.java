...
public enum RedshiftTypeMetadataAlias implements TypeMetadataAlias {
	...
	ARRAY                         ("ARRAY"                          ,StandardTypeMetadata.SUPER                    ,  -1,  -1,  -1),
	BFILE                         ("BFILE"                          ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	BIGINT                        ("BIGINT"                         ,StandardTypeMetadata.BIGINT                   ,   1,   1,   1),
	BIGSERIAL                     ("BIGSERIAL"                      ,StandardTypeMetadata.BIGINT                   ,   1,   1,   1),
	BINARY                        ("BINARY"                         ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	BINARY_DOUBLE                 ("BINARY_DOUBLE"                  ,StandardTypeMetadata.DOUBLE_PRECISION         ,   1,   1,   1),
	BINARY_FLOAT                  ("BINARY_FLOAT"                   ,StandardTypeMetadata.REAL                     ,   1,   0,   0),
	BINARY_INTEGER                ("BINARY_INTEGER"                 ,StandardTypeMetadata.INTEGER                  ,   1,   1,   1),
	BIT                           ("BIT"                            ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1),
	BIT_VARYING                   ("BIT VARYING"                    ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	BITMAP                        ("BITMAP"                         ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1),
	BLOB                          ("BLOB"                           ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	...
	BYTEA                         ("BYTEA"                          ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	...
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.TIMESTAMP                ,   1,   2,   1),
	CLICKHOUSE_DATETIME64         ("DateTime"                       ,StandardTypeMetadata.TIMESTAMP                ,   1,   2,   1),
	DATETIME_WITH_TIME_ZONE       ("DATETIME WITH TIME ZONE"        ,StandardTypeMetadata.TIMESTAMPTZ              ,   1,   2,   1),
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.TIMESTAMP                ,   1,   2,   1),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.TIMESTAMP                ,   1,   2,   1),
	...
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.DOUBLE_PRECISION         ,   1,   1,   1),
	...
	FLOAT                         ("FLOAT"                          ,StandardTypeMetadata.REAL                     ,   1,   0,   0),
	CLICKHOUSE_FLOAT32            ("Float32"                        ,StandardTypeMetadata.REAL                     ,   1,   0,   0),
	FLOAT4                        ("FLOAT4"                         ,StandardTypeMetadata.REAL                     ,   1,   1,   1),
	CLICKHOUSE_FLOAT64            ("Float64"                        ,StandardTypeMetadata.DOUBLE_PRECISION         ,   1,   1,   1),
	FLOAT8                        ("FLOAT8"                         ,StandardTypeMetadata.REAL                     ,   1,   1,   1),
	GEO_POINT                     ("geo_point"                      ,StandardTypeMetadata.GEOMETRY                 ,   1,   1,   1),
	GEO_SHAPE                     ("geo_shape"                      ,StandardTypeMetadata.GEOMETRY                 ,   1,   1,   1),
	GEOGRAPHY                     ("GEOGRAPHY"                      ,StandardTypeMetadata.GEOMETRY                 ,   1,   1,   1),
	GEOGRAPHY_POINT               ("GEOGRAPHY_POINT"                ,StandardTypeMetadata.GEOMETRY                 ,   1,   1,   1),
	GEOMETRY                      ("GEOMETRY"                       ,StandardTypeMetadata.GEOMETRY                 ,   1,   1,   1),
	GEOMETRYCOLLECTION            ("GEOMETRYCOLLECTION"             ,StandardTypeMetadata.GEOMETRY                 ,   1,   1,   1),
	GTSVECTOR                     ("GTSVECTOR"                      ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1),
	GUID                          ("GUID"                           ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1),
	HALF_FLOAT                    ("half_float"                     ,StandardTypeMetadata.REAL                     ,   1,   0,   0),
	...
	CLICKHOUSE_INT32              ("Int32"                          ,StandardTypeMetadata.INTEGER                  ,   1,   1,   1),
	...
	CLICKHOUSE_INT8               ("Int8"                           ,StandardTypeMetadata.SMALLINT                 ,   1,   1,   1),
	...
	JSON                          ("JSON"                           ,StandardTypeMetadata.SUPER                    ,  -1,  -1,  -1),
	JSONB                         ("JSONB"                          ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	JSONPATH                      ("JSONPATH"                       ,StandardTypeMetadata.SUPER                    ,  -1,  -1,  -1),
	KEYWORD                       ("KEYWORD"                        ,StandardTypeMetadata.VARCHAR                  ,   0,   1,   1),
	LARGEINT                      ("LARGEINT"                       ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1),
	LINE                          ("LINE"                           ,StandardTypeMetadata.GEOMETRY                 ,   1,   1,   1),
	LINESTRING                    ("LINESTRING"                     ,StandardTypeMetadata.GEOMETRY                 ,   1,   1,   1),
	LIST                          ("LIST"                           ,StandardTypeMetadata.SUPER                    ,  -1,  -1,  -1),
	LONG_TEXT                     ("LONG"                           ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1),
	LONG                          ("long"                           ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1),
	LONGBLOB                      ("LONGBLOB"                       ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	...
	LVARCHAR                      ("LVARCHAR"                       ,StandardTypeMetadata.VARCHAR                  ,   0,   1,   1),
	...
	POINT                         ("POINT"                          ,StandardTypeMetadata.GEOMETRY                 ,   1,   1,   1),
	...
	SCALED_FLOAT                  ("scaled_float"                   ,StandardTypeMetadata.REAL                     ,   1,   0,   0),
	...
	SIMPLE_DOUBLE                 ("SIMPLE_DOUBLE"                  ,StandardTypeMetadata.DOUBLE_PRECISION         ,   1,   1,   1),
	SIMPLE_FLOAT                  ("SIMPLE_FLOAT"                   ,StandardTypeMetadata.REAL                     ,   1,   0,   0),
	...
	SMALLFLOAT                    ("SMALLFLOAT"                     ,StandardTypeMetadata.REAL                     ,   1,   0,   0),
	...
	STRUCT                        ("STRUCT"                         ,StandardTypeMetadata.SUPER                    ,  -1,  -1,  -1),
	STRUCTS                       ("STRUCTS"                        ,StandardTypeMetadata.SUPER                    ,  -1,  -1,  -1),
	...
	TIME_TZ_UNCONSTRAINED         ("TIME TZ UNCONSTRAINED"          ,StandardTypeMetadata.TIMETZ                   ,  -1,  -1,  -1),
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIMETZ                   ,  -1,  -1,  -1),
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIMETZ                   ,  -1,  -1,  -1),
	TIME_WITHOUT_TIME_ZONE        ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME                     ,   1,   1,   1),
	TIME_WITHOUT_ZONE             ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME                     ,   1,   1,   1),
	...
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMPTZ              ,   1,   2,   1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMPTZ              ,   1,   2,   1),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMPTZ              ,   1,   2,   1),
	...
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.TIMESTAMPTZ              ,   1,   2,   1),
	TIMETZ                        ("TIMETZ"                         ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1),
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.TIMETZ                   ,  -1,  -1,  -1),
	TINYBLOB                      ("TINYBLOB"                       ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	TINYINT                       ("TINYINT"                        ,StandardTypeMetadata.SMALLINT                 ,   1,   1,   1),
	TINYTEXT                      ("TINYTEXT"                       ,StandardTypeMetadata.VARCHAR                  ,   0,   1,   1),
	...
	CLICKHOUSE_UINT32             ("UInt32"                         ,StandardTypeMetadata.INTEGER                  ,   1,   1,   1),
	CLICKHOUSE_UINT64             ("UInt64"                         ,StandardTypeMetadata.BIGINT                   ,   1,   1,   1),
	CLICKHOUSE_UINT8              ("UInt8"                          ,StandardTypeMetadata.SMALLINT                 ,   1,   1,   1),
	...
	VARBINARY                     ("VARBINARY"                      ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	VARBIT                        ("VARBIT"                         ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	...
	VARCHARBYTE                   ("VARCHARBYTE"                    ,StandardTypeMetadata.VARBYTE                  ,  -1,  -1,  -1),
	...
	RedshiftTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this.input = input;

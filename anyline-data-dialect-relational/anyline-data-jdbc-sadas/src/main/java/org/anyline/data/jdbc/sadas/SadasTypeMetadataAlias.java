...
public enum SadasTypeMetadataAlias implements TypeMetadataAlias {
	...
	BIGINT                        ("BIGINT"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	BIGSERIAL                     ("BIGSERIAL"                      ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	BINARY                        ("BINARY"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	BINARY_DOUBLE                 ("BINARY_DOUBLE"                  ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	BINARY_FLOAT                  ("BINARY_FLOAT"                   ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	BOOL                          ("BOOL"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	CHAR                          ("CHAR"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	DATE                          ("DATE"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	INT16                         ("INT16"                          ,StandardTypeMetadata.INT32                         , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	INT2                          ("INT2"                           ,StandardTypeMetadata.INT32                         , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	INT256                        ("INT256"                         ,StandardTypeMetadata.INT32                         , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	INT32                         ("INT32"                          ,StandardTypeMetadata.INT32                         , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	INT4                          ("INT4"                           ,StandardTypeMetadata.INT32                         , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	...
	LONGTEXT                      ("LONGTEXT"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	MEDIUMTEXT                    ("MEDIUMTEXT"                     ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	MONEY                         ("MONEY"                          ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	NCHAR                         ("NCHAR"                          ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	NUMBER                        ("NUMBER"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	NUMERIC                       ("NUMERIC"                        ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	NUMRANGE                      ("NUMRANGE"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	NVARCHAR                      ("NVARCHAR"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	NVARCHAR2                     ("NVARCHAR2"                      ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	REAL                          ("REAL"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	SERIAL                        ("SERIAL"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	SERIAL2                       ("SERIAL2"                        ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	SERIAL4                       ("SERIAL4"                        ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	SERIAL8                       ("SERIAL8"                        ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	SMALLDECIMAL                  ("SMALLDECIMAL"                   ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   0),
	SMALLFLOAT                    ("SMALLFLOAT"                     ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	SMALLINT                      ("SMALLINT"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	SMALLMONEY                    ("SMALLMONEY"                     ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	SMALLSERIAL                   ("SMALLSERIAL"                    ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	TEXT                          ("TEXT"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	TID                           ("TID"                            ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	TIME                          ("TIME"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.NONE                          ,   1,  -1,  -1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP_WITH_LOCAL_ZONE     ,   1,   2,   1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      ,   1,   1,   2),
	...
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	TINYBLOB                      ("TINYBLOB"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	TINYINT                       ("TINYINT"                        ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	TINYTEXT                      ("TINYTEXT"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	VARCHAR                       ("VARCHAR"                        ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	VARCHAR2                      ("VARCHAR2"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	YEAR                          ("YEAR"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	...
	SadasTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this.input = input;

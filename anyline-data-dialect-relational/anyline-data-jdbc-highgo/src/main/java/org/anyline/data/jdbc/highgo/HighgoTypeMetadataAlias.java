...
public enum HighgoTypeMetadataAlias implements TypeMetadataAlias {
	...
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP_WITH_LOCAL_ZONE     , "TIMESTAMPTZ" , "TIMESTAMPTZ({S})" , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	...
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.TIMEZ                         ,   1,   1,   1,  -1,  -1,  -1),
	...
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"   , "TIMESTAMP({S})"   , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	...
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"   , "TIMESTAMP({S})"   , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"   , "TIMESTAMP({S})"   , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),

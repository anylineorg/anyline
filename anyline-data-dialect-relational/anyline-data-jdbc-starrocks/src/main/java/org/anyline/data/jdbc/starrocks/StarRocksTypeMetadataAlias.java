...
public enum StarRocksTypeMetadataAlias implements TypeMetadataAlias {
	...
	DECIMAL                       ("DECIMAL"                        ,StandardTypeMetadata.NONE                          , null       , null            , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,  -1,  -1,  -1),
	...
	NCHAR                         ("NCHAR"                          ,StandardTypeMetadata.NONE                          , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,  -1,  -1,  -1),
	...
	NUMBER                        ("NUMBER"                         ,StandardTypeMetadata.NONE                          , null       , null            , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,  -1,  -1,  -1),
	NUMERIC                       ("NUMERIC"                        ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	NUMRANGE                      ("NUMRANGE"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	NVARCHAR                      ("NVARCHAR"                       ,StandardTypeMetadata.NONE                          , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,  -1,  -1,  -1),
	NVARCHAR2                     ("NVARCHAR2"                      ,StandardTypeMetadata.NONE                          , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,  -1,  -1,  -1),
	...
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP_WITH_LOCAL_ZONE     , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   2,   1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2),
	...
	VARCHAR                       ("VARCHAR"                        ,StandardTypeMetadata.NONE                          , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,  -1,  -1,  -1),
	VARCHAR2                      ("VARCHAR2"                       ,StandardTypeMetadata.NONE                          , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,  -1,  -1,  -1),
	...
	StarRocksTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale){
		this.input = input;

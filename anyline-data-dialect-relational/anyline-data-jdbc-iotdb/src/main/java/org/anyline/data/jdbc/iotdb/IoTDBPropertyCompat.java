...
public enum IoTDBPropertyCompat implements PropertyCompat {
	...
	IoTDBPropertyCompat(Class<? extends Metadata> metadata, String property, String compat, String optimal) {

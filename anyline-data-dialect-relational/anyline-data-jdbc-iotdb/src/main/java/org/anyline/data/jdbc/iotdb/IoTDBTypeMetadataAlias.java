...
public enum IoTDBTypeMetadataAlias implements TypeMetadataAlias {
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.DOUBLE     , null       , null            , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,   1,   0,   0,  -1,  -1,  -1),
	...
	BIGINT                        ("BIGINT"                         ,StandardTypeMetadata.INT64      , "INT64"    , "INT64"         , null                       , "NUMERIC_PRECISION"  , null            ,   1,   1,   1,  -1,  -1,  -1),
	BIGSERIAL                     ("BIGSERIAL"                      ,StandardTypeMetadata.INT64      ,   1,   1,   1,  -1,  -1,  -1),
	...
	BPCHAR                        ("BPCHAR"                         ,StandardTypeMetadata.TEXT       ,   1,   1,   1,  -1,  -1,  -1),
	...
	DATE                          ("DATE"                           ,StandardTypeMetadata.TEXT       ,   1,   1,   1,  -1,  -1,  -1),
	DATE_NANOS                    ("date_nanos"                     ,StandardTypeMetadata.NONE       ,  -1,  -1,  -1,  -1,  -1,  -1),
	DATE32                        ("Date32"                         ,StandardTypeMetadata.DATETIME   ,   1,   1,   1,  -1,  -1,  -1),
	DATERANGE                     ("DATERANGE"                      ,StandardTypeMetadata.NONE       ,  -1,  -1,  -1,  -1,  -1,  -1),
	DATETIME64                    ("DateTime"                       ,StandardTypeMetadata.DATETIME   ,   1,   1,   1,  -1,  -1,  -1),
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.DATETIME   , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	DATETIME_WITH_TIME_ZONE       ("DATETIME WITH TIME ZONE"        ,StandardTypeMetadata.DATETIME   ,   1,   1,   1,  -1,  -1,  -1),
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.INT64      ,   1,   1,   1,  -1,  -1,  -1),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.INT64      ,   1,   1,   1,  -1,  -1,  -1),
	DATETIMEV2                    ("DATETIMEV2"                     ,StandardTypeMetadata.DATETIME   ,   1,   1,   1,  -1,  -1,  -1),
	DATEV2                        ("DATEV2"                         ,StandardTypeMetadata.TEXT       ,   1,   1,   1,  -1,  -1,  -1),
	DEC                           ("DEC"                            ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0,  -1,  -1,  -1),
	DECFLOAT                      ("DECFLOAT"                       ,StandardTypeMetadata.NONE       ,  -1,  -1,  -1,  -1,  -1,  -1),
	DECIMAL                       ("DECIMAL"                        ,StandardTypeMetadata.DOUBLE     , null       , null            , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,   1,   0,   0,  -1,  -1,  -1),
	DECIMAL128                    ("Decimal128"                     ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0,  -1,  -1,  -1),
	DECIMAL256                    ("Decimal256"                     ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0,  -1,  -1,  -1),
	DECIMAL32                     ("Decimal32"                      ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0,  -1,  -1,  -1),
	DECIMAL64                     ("Decimal64"                      ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0,  -1,  -1,  -1),
	...
	FIXED_STRING                  ("FIXED_STRING"                   ,StandardTypeMetadata.TEXT       ,   1,   1,   1,  -1,  -1,  -1),
	FIXEDSTRING                   ("FixedString"                    ,StandardTypeMetadata.TEXT       ,   1,   1,   1,  -1,  -1,  -1),
	...
	INT                           ("INT"                            ,StandardTypeMetadata.INT32      , "INT32"    , "INT32"         , null                       , "NUMERIC_PRECISION"  , null            ,   1,   1,   1,  -1,  -1,  -1),
	INT128                        ("INT128"                         ,StandardTypeMetadata.INT64      , "INT32"    , "INT32"         , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	INT16                         ("INT16"                          ,StandardTypeMetadata.INT32      , "INT32"    , "INT32"         , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	INT2                          ("INT2"                           ,StandardTypeMetadata.INT32      , "INT32"    , "INT32"         , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	...
	INT8                          ("INT8"                           ,StandardTypeMetadata.INT64      , "INT64"    , "INT64"         , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	...
	KEYWORD                       ("KEYWORD"                        ,StandardTypeMetadata.TEXT       ,   1,   1,   1,  -1,  -1,  -1),
	...
	LVARCHAR                      ("LVARCHAR"                       ,StandardTypeMetadata.TEXT       , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	...
	MEDIUMINT                     ("MEDIUMINT"                      ,StandardTypeMetadata.INT32      , "INT32"    , "INT32"         , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	MEDIUMTEXT                    ("MEDIUMTEXT"                     ,StandardTypeMetadata.TEXT       ,   1,   1,   1,  -1,  -1,  -1),
	MONEY                         ("MONEY"                          ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0,  -1,  -1,  -1),
	...
	NCHAR                         ("NCHAR"                          ,StandardTypeMetadata.TEXT       , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	...
	NUMBER                        ("NUMBER"                         ,StandardTypeMetadata.DOUBLE     , null       , null            , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,   1,   0,   0,  -1,  -1,  -1),
	NUMERIC                       ("NUMERIC"                        ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0,  -1,  -1,  -1),
	NUMRANGE                      ("NUMRANGE"                       ,StandardTypeMetadata.NONE       ,  -1,  -1,  -1,  -1,  -1,  -1),
	NVARCHAR                      ("NVARCHAR"                       ,StandardTypeMetadata.TEXT       , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	NVARCHAR2                     ("NVARCHAR2"                      ,StandardTypeMetadata.TEXT       , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	...
	REAL                          ("REAL"                           ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0,  -1,  -1,  -1),
	...
	SERIAL8                       ("SERIAL8"                        ,StandardTypeMetadata.INT64      ,   1,   1,   1,  -1,  -1,  -1),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.DATETIME   , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	SMALLDECIMAL                  ("SMALLDECIMAL"                   ,StandardTypeMetadata.DOUBLE     , null       , null            , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,   1,   0,   0,  -1,  -1,  -1),
	SMALLFLOAT                    ("SMALLFLOAT"                     ,StandardTypeMetadata.FLOAT      ,   1,   2,   3,  -1,  -1,  -1),
	SMALLINT                      ("SMALLINT"                       ,StandardTypeMetadata.INT32      , "INT32"    , "INT32"         , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	SMALLMONEY                    ("SMALLMONEY"                     ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0,  -1,  -1,  -1),
	...
	SQL_DATETIMEOFFSET            ("SQL_DATETIMEOFFSET"             ,StandardTypeMetadata.DATETIME   ,   1,   1,   1,  -1,  -1,  -1),
	...
	STRING                        ("STRING"                         ,StandardTypeMetadata.VARCHAR    ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	TIME                          ("TIME"                           ,StandardTypeMetadata.DATETIME   , "TIME"     , "TIME({S})"     , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.DATETIME   ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2,  -1,  -1,  -1),
	TIMETZ                        ("TIMETZ"                         ,StandardTypeMetadata.NONE       ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.DATETIME   ,   1,   1,   1,  -1,  -1,  -1),
	TINYBLOB                      ("TINYBLOB"                       ,StandardTypeMetadata.NONE       ,  -1,  -1,  -1,  -1,  -1,  -1),
	TINYINT                       ("TINYINT"                        ,StandardTypeMetadata.INT32      , "INT32"    , "INT32"         , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	...
	UINT16                        ("UInt16"                         ,StandardTypeMetadata.INT32      , "INT32"    , "INT32"         , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	...
	UINT64                        ("UInt64"                         ,StandardTypeMetadata.INT32      , "INT32"    , "INT32"         , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	UINT8                         ("UInt8"                          ,StandardTypeMetadata.INT32      , "INT32"    , "INT32"         , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	...
	VARBINARY                     ("VARBINARY"                      ,StandardTypeMetadata.TEXT       ,   1,   1,   1,  -1,  -1,  -1),
	VARBIT                        ("VARBIT"                         ,StandardTypeMetadata.NONE       ,  -1,  -1,  -1,  -1,  -1,  -1),
	VARBYTE                       ("VARBYTE"                        ,StandardTypeMetadata.NONE       ,  -1,  -1,  -1,  -1,  -1,  -1),
	VARCHAR                       ("VARCHAR"                        ,StandardTypeMetadata.TEXT       , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	VARCHAR2                      ("VARCHAR2"                       ,StandardTypeMetadata.TEXT       , null       , null            , "CHARACTER_MAXIMUM_LENGTH" , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),
	...
	YEAR                          ("YEAR"                           ,StandardTypeMetadata.INT32      , "INT"      , "INT"           , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,  -1),

...
public enum IoTDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	BIGINT                        ("BIGINT"                         ,StandardTypeMetadata.INT64      , null       , null            , null                       , "NUMERIC_PRECISION"  , null            ,   1,   1,   1),
	...
	CLICKHOUSE_DATE32             ("Date32"                         ,StandardTypeMetadata.DATETIME   ,   1,   1,   1),
	...
	CLICKHOUSE_DECIMAL128         ("Decimal128"                     ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0),
	CLICKHOUSE_DECIMAL256         ("Decimal256"                     ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0),
	CLICKHOUSE_DECIMAL32          ("Decimal32"                      ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0),
	CLICKHOUSE_DECIMAL64          ("Decimal64"                      ,StandardTypeMetadata.DOUBLE     ,   1,   0,   0),
	...
	CLICKHOUSE_INT128             ("Int128"                         ,StandardTypeMetadata.INT64      ,   1,   1,   1),
	INT128                        ("INT128"                         ,StandardTypeMetadata.INT64      ,   1,   1,   1),
	CLICKHOUSE_INT16              ("Int16"                          ,StandardTypeMetadata.INT32      ,   1,   1,   1),
	INT16                         ("INT16"                          ,StandardTypeMetadata.INT32      ,   1,   1,   1),
	INT2                          ("INT2"                           ,StandardTypeMetadata.INT32      ,   1,   1,   1),
	CLICKHOUSE_INT256             ("Int256"                         ,StandardTypeMetadata.INT64      ,   1,   1,   1),
	INT256                        ("INT256"                         ,StandardTypeMetadata.INT64      ,   1,   1,   1),
	CLICKHOUSE_INT32              ("Int32"                          ,StandardTypeMetadata.INT32      ,   1,   1,   1),
	INT4                          ("INT4"                           ,StandardTypeMetadata.INT32      ,   1,   1,   1),
	INT4RANGE                     ("INT4RANGE"                      ,StandardTypeMetadata.NONE       ,  -1,  -1,  -1),
	CLICKHOUSE_INT64              ("Int64"                          ,StandardTypeMetadata.INT64      ,   1,   1,   1),
	CLICKHOUSE_INT8               ("Int8"                           ,StandardTypeMetadata.INT32      ,   1,   1,   1),
	...
	CLICKHOUSE_UINT128            ("UInt128"                        ,StandardTypeMetadata.INT64      ,   1,   1,   1),
	CLICKHOUSE_UINT16             ("UInt16"                         ,StandardTypeMetadata.INT32      ,   1,   1,   1),
	CLICKHOUSE_UINT256            ("UInt256"                        ,StandardTypeMetadata.INT64      ,   1,   1,   1),
	CLICKHOUSE_UINT32             ("UInt32"                         ,StandardTypeMetadata.INT32      ,   1,   1,   1),
	CLICKHOUSE_UINT64             ("UInt64"                         ,StandardTypeMetadata.INT32      ,   1,   1,   1),
	CLICKHOUSE_UINT8              ("UInt8"                          ,StandardTypeMetadata.INT32      ,   1,   1,   1),

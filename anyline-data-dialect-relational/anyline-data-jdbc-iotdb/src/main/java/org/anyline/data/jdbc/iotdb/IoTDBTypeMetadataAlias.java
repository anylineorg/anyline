...
public enum IoTDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.INT64                         , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   1),
	...
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.INT64                         , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   1),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.INT64                         , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   1),
	...
	INT128                        ("INT128"                         ,StandardTypeMetadata.INT128                        ,   1,   1,   1),
	...
	INT256                        ("INT256"                         ,StandardTypeMetadata.INT256                        ,   1,   1,   1),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.INT64                         , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   1),
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.INT64                         , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.INT64                         , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.INT64                         , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1),
	...
	VARBIT                        ("VARBIT"                         ,StandardTypeMetadata.VARBINARY                     ,  -1,  -1,  -1),

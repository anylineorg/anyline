...
public enum IoTDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.DATETIME   , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,   6),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.DATETIME   , "DATETIME" , "DATETIME({S})" , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,   6),
	...
	SQL_DATETIMEOFFSET            ("SQL_DATETIMEOFFSET"             ,StandardTypeMetadata.DATETIME   ,   1,   1,   1,  -1,  -1,   6),
	...
	TIME                          ("TIME"                           ,StandardTypeMetadata.DATETIME   , "TIME"     , "TIME({S})"     , null                       , null                 , null            ,   1,   1,   1,  -1,  -1,   6),
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,   6),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,   6),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,   6),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,   6),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,   6),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   1,  -1,  -1,   6),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.DATETIME   ,   1,   1,   1,  -1,  -1,   6),
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.DATETIME   , null       , null            , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2,  -1,  -1,   6),

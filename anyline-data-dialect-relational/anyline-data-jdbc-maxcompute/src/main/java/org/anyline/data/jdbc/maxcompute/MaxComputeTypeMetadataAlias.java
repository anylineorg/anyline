...
public enum MaxComputeTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME64                    ("DateTime"                       ,StandardTypeMetadata.DATETIME        ,   1,   1,   1),
	...
	LONG                          ("long"                           ,StandardTypeMetadata.BIGINT          ,   1,   1,   1),
	...
	MEDIUMINT                     ("MEDIUMINT"                      ,StandardTypeMetadata.INT32           , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	...
	SERIAL                        ("SERIAL"                         ,StandardTypeMetadata.INT32           , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	SERIAL2                       ("SERIAL2"                        ,StandardTypeMetadata.INT32           , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	SERIAL4                       ("SERIAL4"                        ,StandardTypeMetadata.INT32           , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	SERIAL8                       ("SERIAL8"                        ,StandardTypeMetadata.INT32           , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	SET                           ("SET"                            ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1),
	SHAPE                         ("shape"                          ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1),
	SHORT                         ("SHORT"                          ,StandardTypeMetadata.INT32           , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	...
	SIMPLE_INTEGER                ("SIMPLE_INTEGER"                 ,StandardTypeMetadata.INT32           , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.TIMESTAMP_NTZ   ,  -1,  -1,  -1),
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1),
	...
	UINT16                        ("UInt16"                         ,StandardTypeMetadata.INT32           , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	...
	UINT8                         ("UInt8"                          ,StandardTypeMetadata.INT32           , "INT"  , "INT"  , null   , null   , null   ,   1,   1,   1),
	...
	MaxComputeTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this.input = input;

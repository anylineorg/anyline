...
package org.anyline.data.jdbc.maxcompute;

import org.anyline.metadata.type.TypeMetadataAlias;
import org.anyline.metadata.type.init.StandardTypeMetadata;
import org.anyline.metadata.type.TypeMetadata;

public enum MaxComputeTypeMetadataAlias implements TypeMetadataAlias {
	...
	CHAR                      ("CHAR"                      ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	CLOB                      ("CLOB"                      ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	DATETIME                  ("DATETIME"                  ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	DATETIME64                ("DateTime"                  ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	DATETIME2                 ("DATETIME2"                 ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	DATETIMEOFFSET            ("DATETIMEOFFSET"            ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	DATETIMEV2                ("DATETIMEV2"                ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	INT256                    ("INT256"                    ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	LONG                      ("long"                      ,StandardTypeMetadata.BIGINT          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	MULTILINESTRING           ("MULTILINESTRING"           ,StandardTypeMetadata.STRING          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SERIAL8                   ("SERIAL8"                   ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	SET                       ("SET"                       ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	SHAPE                     ("shape"                     ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	SHORT                     ("SHORT"                     ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	SIGNTYPE                  ("SIGNTYPE"                  ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	SIMPLE_DOUBLE             ("SIMPLE_DOUBLE"             ,StandardTypeMetadata.DOUBLE          ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	SIMPLE_FLOAT              ("SIMPLE_FLOAT"              ,StandardTypeMetadata.FLOAT           ,   1,   2,   3,  -1,  -1,  -1,  -1,  -1),
	SIMPLE_INTEGER            ("SIMPLE_INTEGER"            ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	SIMPLEAGGREGATEFUNCTION   ("SimpleAggregateFunction"   ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	SMALLDATETIME             ("SMALLDATETIME"             ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SMALLMONEY                ("SMALLMONEY"                ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	SMALLSERIAL               ("SMALLSERIAL"               ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	TIME                      ("TIME"                      ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TIME_TZ_UNCONSTRAINED     ("TIME TZ UNCONSTRAINED"     ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TIME_UNCONSTRAINED        ("TIME_UNCONSTRAINED"        ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMP                 ("TIMESTAMP"                 ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMP_NTZ             ("TIMESTAMP_NTZ"             ,StandardTypeMetadata.TIMESTAMP_NTZ   ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMPTZ               ("TIMESTAMPTZ"               ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1,  -1,  -1,  -1,  -1,  -1),
	TIMETZ                    ("TIMETZ"                    ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMEZ                     ("TIMEZ"                     ,StandardTypeMetadata.TIME            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	UINT128                   ("UInt128"                   ,StandardTypeMetadata.BIGINT          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	UINT8                     ("UInt8"                     ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	VARBINARY                 ("VARBINARY"                 ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	VARBIT                    ("VARBIT"                    ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	MaxComputeTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
		this.input = input;
	...
	MaxComputeTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
		this.standard = standard;
		this.meta = meta;
		this.formula = formula;
	...
	MaxComputeTypeMetadataAlias(String input, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null , null, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	MaxComputeTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}

	MaxComputeTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
	...
	MaxComputeTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, meta, formula, null, null, null, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	MaxComputeTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null, null, null, ignoreLength, ignorePrecision, ignoreScale);
	}

	MaxComputeTypeMetadataAlias(TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(null, standard, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale);
	}

	MaxComputeTypeMetadataAlias(String input, TypeMetadata standard) {
		this.input = input;
		this.standard = standard;
	}

	MaxComputeTypeMetadataAlias(TypeMetadata standard) {
		this.standard = standard;
	}

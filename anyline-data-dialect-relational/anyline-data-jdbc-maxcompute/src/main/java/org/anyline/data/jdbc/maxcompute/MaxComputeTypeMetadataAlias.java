...
public enum MaxComputeTypeMetadataAlias implements TypeMetadataAlias {
	...
	BLOB                          ("BLOB"                           ,StandardTypeMetadata.ILLEGAL         ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	DATE32                        ("Date32"                         ,StandardTypeMetadata.DATE            ,   1,   1,   1,  -1,  -1,  -1),
	DATERANGE                     ("DATERANGE"                      ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1),
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	DATETIME64                    ("DateTime"                       ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	DATETIME_WITH_TIME_ZONE       ("DATETIME WITH TIME ZONE"        ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	...
	INT256                        ("INT256"                         ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	...
	INT64                         ("INT64"                          ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	INT8                          ("INT8"                           ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	...
	LONG                          ("long"                           ,StandardTypeMetadata.BIGINT          ,   1,   1,   1,  -1,  -1,  -1),
	...
	MULTILINESTRING               ("MULTILINESTRING"                ,StandardTypeMetadata.STRING          ,   1,   1,   1,  -1,  -1,  -1),
	...
	NCLOB                         ("NCLOB"                          ,StandardTypeMetadata.STRING          ,   1,   1,   1,  -1,  -1,  -1),
	...
	SERIAL8                       ("SERIAL8"                        ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	SET                           ("SET"                            ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1),
	SHAPE                         ("shape"                          ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1),
	SHORT                         ("SHORT"                          ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	...
	SIMPLE_INTEGER                ("SIMPLE_INTEGER"                 ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	SIMPLEAGGREGATEFUNCTION       ("SimpleAggregateFunction"        ,StandardTypeMetadata.NONE            ,  -1,  -1,  -1,  -1,  -1,  -1),
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	...
	TIME                          ("TIME"                           ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	TIME_TZ_UNCONSTRAINED         ("TIME TZ UNCONSTRAINED"          ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITHOUT_TIME_ZONE        ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITHOUT_ZONE             ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	TIME_UNCONSTRAINED            ("TIME_UNCONSTRAINED"             ,StandardTypeMetadata.DATETIME        ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.TIMESTAMP_NTZ   ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.TIMESTAMP       ,   1,   2,   1,  -1,  -1,  -1),
	...
	UINT128                       ("UInt128"                        ,StandardTypeMetadata.BIGINT          ,   1,   1,   1,  -1,  -1,  -1),
	UINT16                        ("UInt16"                         ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	UINT256                       ("UInt256"                        ,StandardTypeMetadata.BIGINT          ,   1,   1,   1,  -1,  -1,  -1),
	UINT32                        ("UInt32"                         ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	UINT64                        ("UInt64"                         ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	UINT8                         ("UInt8"                          ,StandardTypeMetadata.INT32           , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),

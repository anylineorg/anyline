...
public enum SinoDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	MULTISET                  ("MULTISET"                  ,StandardTypeMetadata.MULTISET    ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	BYTEA                     ("BYTEA"                     ,StandardTypeMetadata.BYTE        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	DOUBLE                    ("DOUBLE"                    ,StandardTypeMetadata.FLOAT       ,   1,   2,   3,  -1,  -1,  -1,  -1,  -1),
	...
	INT                       ("INT"                       ,StandardTypeMetadata.INT8        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT128                    ("INT128"                    ,StandardTypeMetadata.INT32       , "INT"      , "INT"           , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT16                     ("INT16"                     ,StandardTypeMetadata.BIGINT      ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT2                      ("INT2"                      ,StandardTypeMetadata.SMALLINT    ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT256                    ("INT256"                    ,StandardTypeMetadata.BIGINT      ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT32                     ("INT32"                     ,StandardTypeMetadata.BIGINT      ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	INT4                      ("INT4"                      ,StandardTypeMetadata.INT8        ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SinoDBTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
		this.input = input;
	...
	SinoDBTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
		this.standard = standard;
		this.meta = meta;
		this.formula = formula;
	...
	SinoDBTypeMetadataAlias(String input, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null , null, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	SinoDBTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}

	SinoDBTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
	...
	SinoDBTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, meta, formula, null, null, null, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	SinoDBTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale) {
	...
	SinoDBTypeMetadataAlias(String input, TypeMetadata standard) {
		this.input = input;
		this.standard = standard;
	}

...
public enum DruidTypeMetadataAlias implements TypeMetadataAlias {
	...
	CHARACTER                     ("CHARACTER"                      ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	DATETIMEV2                    ("DATETIMEV2"                     ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	DATEV2                        ("DATEV2"                         ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	DEC                           ("DEC"                            ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	DECFLOAT                      ("DECFLOAT"                       ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	DECIMAL                       ("Decimal"                        ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	DECIMAL128                    ("Decimal128"                     ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	DECIMAL256                    ("Decimal256"                     ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	DECIMAL32                     ("Decimal32"                      ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	DECIMAL64                     ("Decimal64"                      ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	FixedString                   ("FixedString"                    ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	INT                           ("int"                            ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT128                        ("Int128"                         ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT16                         ("Int16"                          ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT2                          ("INT2"                           ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT256                        ("Int256"                         ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT32                         ("Int32"                          ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT4                          ("INT4"                           ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT4RANGE                     ("INT4RANGE"                      ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT64                         ("Int64"                          ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT8                          ("INT8"                           ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT8RANGE                     ("INT8RANGE"                      ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	INTEGER                       ("INTEGER"                        ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	KEYWORD                       ("keyword"                        ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	SMALLDECIMAL                  ("SMALLDECIMAL"                   ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIME_WITHOUT_TIME_ZONE        ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIME_WITHOUT_ZONE             ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.NONE      ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	DruidTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
	...
	DruidTypeMetadataAlias(String input, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null , null, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	DruidTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}
	DruidTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, meta, formula, null, null, null, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	DruidTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null, null, null, ignoreLength, ignorePrecision, ignoreScale);
	}

	DruidTypeMetadataAlias(TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(null, standard, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale);
	}

	DruidTypeMetadataAlias(String input, TypeMetadata standard) {
		this.input = input;
		this.standard = standard;
	}

	DruidTypeMetadataAlias(TypeMetadata standard) {
		this.standard = standard;
	}

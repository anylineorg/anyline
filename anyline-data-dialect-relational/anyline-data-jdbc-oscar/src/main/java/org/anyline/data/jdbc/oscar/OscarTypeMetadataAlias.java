...
public enum OscarTypeMetadataAlias implements TypeMetadataAlias {
	...
	SQL_DATETIMEOFFSET            ("SQL_DATETIMEOFFSET"             ,StandardTypeMetadata.DATETIME                      , "DATETIME"                  , "DATETIME({S})"                  , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	...
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIMESTAMP"                 , "TIMESTAMP({S}) "                , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIMESTAMP"                 , "TIMESTAMP({S}) "                , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	...
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                 , "TIMESTAMP({S})"                 , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                 , "TIMESTAMP({S})"                 , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	...
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP WITH TIME ZONE"  , "TIMESTAMP({S}) WITH TIME ZONE"  , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),

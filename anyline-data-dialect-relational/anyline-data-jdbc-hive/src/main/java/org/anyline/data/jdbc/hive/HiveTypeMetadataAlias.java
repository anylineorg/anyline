...
public enum HiveTypeMetadataAlias implements TypeMetadataAlias {
	...
	STRUCTS                       ("STRUCTS"                        ,StandardTypeMetadata.STRUCTS                       ,  -1,  -1,  -1),
	...
	DATERANGE                     ("DATERANGE"                      ,StandardTypeMetadata.TIMESTAMP                     ,   1,   2,   1),
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.TIMESTAMP                     , "DATETIME"       , null   , null   , null   , null   ,   1,   1,   1),
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.TIMESTAMP                     , "DATETIME2"      , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_DATETIME64         ("DATETIME64"                     ,StandardTypeMetadata.TIMESTAMP                     ,   1,   2,   1),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.TIMESTAMP                     , "DATETIMEOFFSET" , null   , null   , null   , null   ,   1,   1,   1),
	...
	DOUBLE_PRECISION              ("DOUBLE PRECISION"               ,StandardTypeMetadata.DOUBLE                        ,   1,   0,   0),
	...
	CLICKHOUSE_INT128             ("INT128"                         ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	INT128                        ("INT128"                         ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	INT16                         ("INT16"                          ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	CLICKHOUSE_INT16              ("INT16"                          ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	INT2                          ("INT2"                           ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	CLICKHOUSE_INT256             ("INT256"                         ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	...
	INT4RANGE                     ("INT4RANGE"                      ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	...
	CLICKHOUSE_INT8               ("INT8"                           ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	...
	LONGTEXT                      ("LONGTEXT"                       ,StandardTypeMetadata.STRING                        , "LONGTEXT"       , null   , null   , null   , null   ,   1,   1,   1),
	...
	NCLOB                         ("NCLOB"                          ,StandardTypeMetadata.STRING                        , "TEXT"           , null   , null   , null   , null   ,   1,   1,   1),
	NESTED                        ("nested"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	NTEXT                         ("NTEXT"                          ,StandardTypeMetadata.STRING                        , "TEXT"           , null   , null   , null   , null   ,   1,   1,   1),
	NUMBER                        ("NUMBER"                         ,StandardTypeMetadata.DECIMAL                       , "NUMERIC"        , null   , null   , null   , null   ,   1,   0,   0),
	NUMERIC                       ("NUMERIC"                        ,StandardTypeMetadata.DECIMAL                       , "NUMERIC"        , null   , null   , null   , null   ,   1,   0,   0),
	...
	SMALLDECIMAL                  ("SMALLDECIMAL"                   ,StandardTypeMetadata.TIMESTAMP                     ,   1,   2,   1),
	...
	SQL_DATETIMEOFFSET            ("SQL_DATETIMEOFFSET"             ,StandardTypeMetadata.TIMESTAMP                     ,   1,   2,   1),
	...
	STRUCT                        ("STRUCT"                         ,StandardTypeMetadata.STRUCTS                       ,  -1,  -1,  -1),
	...
	TIME_TZ_UNCONSTRAINED         ("TIME TZ UNCONSTRAINED"          ,StandardTypeMetadata.TIMESTAMP                     ,   1,   2,   1),
	...
	TIME_UNCONSTRAINED            ("TIME_UNCONSTRAINED"             ,StandardTypeMetadata.TIMESTAMP                     ,   1,   2,   1),
	...
	CLICKHOUSE_UINT16             ("UINT16"                         ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	CLICKHOUSE_UINT256            ("UINT256"                        ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	CLICKHOUSE_UINT32             ("UINT32"                         ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	CLICKHOUSE_UINT64             ("UINT64"                         ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	CLICKHOUSE_UINT8              ("UINT8"                          ,StandardTypeMetadata.INT                           ,   1,   1,   1),

...
public enum HiveTypeMetadataAlias implements TypeMetadataAlias {
	...
	CLICKHOUSE_DATETIME64         ("DateTime"                       ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1),
	...
	CLICKHOUSE_INT256             ("Int256"                         ,StandardTypeMetadata.BIGINT                        ,   1,   1,   1),
	...
	SIMPLEAGGREGATEFUNCTION       ("SimpleAggregateFunction"        ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	...
	CLICKHOUSE_UINT128            ("UInt128"                        ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	CLICKHOUSE_UINT16             ("UInt16"                         ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1),
	CLICKHOUSE_UINT256            ("UInt256"                        ,StandardTypeMetadata.BIGINT                        ,   1,   1,   1),
	CLICKHOUSE_UINT32             ("UInt32"                         ,StandardTypeMetadata.INT                           ,   1,   1,   1),
	CLICKHOUSE_UINT64             ("UInt64"                         ,StandardTypeMetadata.INT                           ,   1,   1,   1),

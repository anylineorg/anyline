...
public enum HiveTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	DECIMAL                       ("DECIMAL"                        ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   0,  -1,  -1,  -1),
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.DOUBLE                        ,   1,   1,   1,  -1,  -1,  -1),
	DOUBLE_PRECISION              ("DOUBLE PRECISION"               ,StandardTypeMetadata.DOUBLE_PRECISION              ,   1,   1,   1,  -1,  -1,  -1),
	...
	STRING                        ("STRING"                         ,StandardTypeMetadata.STRING                        ,   0,   1,   1,  -1,  -1,  -1),
	TIME                          ("TIME"                           ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	...
	BINARY_INTEGER                ("BINARY_INTEGER"                 ,StandardTypeMetadata.INT32                         , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	...
	BLOB                          ("BLOB"                           ,StandardTypeMetadata.BINARY                        ,   1,   1,   1,  -1,  -1,  -1),
	...
	BYTE                          ("BYTE"                           ,StandardTypeMetadata.BINARY                        ,   0,   1,   1,  -1,  -1,  -1),
	BYTEA                         ("BYTEA"                          ,StandardTypeMetadata.BINARY                        ,   0,   1,   1,  -1,  -1,  -1),
	CHARACTER                     ("CHARACTER"                      ,StandardTypeMetadata.CHAR                          ,   0,   1,   1,  -1,  -1,  -1),
	...
	DATERANGE                     ("DATERANGE"                      ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	DATETIME64                    ("DateTime"                       ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	DATETIME_WITH_TIME_ZONE       ("DATETIME WITH TIME ZONE"        ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	DATETIMEV2                    ("DATETIMEV2"                     ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	...
	IMAGE                         ("IMAGE"                          ,StandardTypeMetadata.BINARY                        ,   1,   1,   1,  -1,  -1,  -1),
	INET                          ("INET"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	INT128                        ("INT128"                         ,StandardTypeMetadata.BIGINT                        ,   1,   1,   1,  -1,  -1,  -1),
	INT16                         ("INT16"                          ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1,  -1,  -1,  -1),
	INT2                          ("INT2"                           ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1,  -1,  -1,  -1),
	...
	INT4                          ("INT4"                           ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1,  -1,  -1,  -1),
	...
	INT8RANGE                     ("INT8RANGE"                      ,StandardTypeMetadata.INT32                         , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	...
	REAL                          ("REAL"                           ,StandardTypeMetadata.NONE                          ,   1,   0,   0,  -1,  -1,  -1),
	...
	SERIAL4                       ("SERIAL4"                        ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1,  -1,  -1,  -1),
	SERIAL8                       ("SERIAL8"                        ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1,  -1,  -1,  -1),
	SHAPE                         ("shape"                          ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	SHORT                         ("SHORT"                          ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1,  -1,  -1,  -1),
	SIGNTYPE                      ("SIGNTYPE"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	SIMPLE_DOUBLE                 ("SIMPLE_DOUBLE"                  ,StandardTypeMetadata.DOUBLE                        ,   1,   1,   1,  -1,  -1,  -1),
	SIMPLE_FLOAT                  ("SIMPLE_FLOAT"                   ,StandardTypeMetadata.FLOAT                         ,   1,   2,   3,  -1,  -1,  -1),
	SIMPLE_INTEGER                ("SIMPLE_INTEGER"                 ,StandardTypeMetadata.SMALLINT                      ,   1,   2,   3,  -1,  -1,  -1),
	SIMPLEAGGREGATEFUNCTION       ("SimpleAggregateFunction"        ,StandardTypeMetadata.INT32                         , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	SMALLDECIMAL                  ("SMALLDECIMAL"                   ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	...
	SQL_DATETIMEOFFSET            ("SQL_DATETIMEOFFSET"             ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	...
	TIME_TZ_UNCONSTRAINED         ("TIME TZ UNCONSTRAINED"          ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITHOUT_TIME_ZONE        ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITHOUT_ZONE             ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIME_UNCONSTRAINED            ("TIME_UNCONSTRAINED"             ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TIMETZ                        ("TIMETZ"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   1,  -1,  -1,  -1),
	TINYBLOB                      ("TINYBLOB"                       ,StandardTypeMetadata.BINARY                        ,   1,   1,   1,  -1,  -1,  -1),
	...
	UINT128                       ("UInt128"                        ,StandardTypeMetadata.INT32                         , "INT"     , "INT"          , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	UINT16                        ("UInt16"                         ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1,  -1,  -1,  -1),
	...
	UINT8                         ("UInt8"                          ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1,  -1,  -1,  -1),

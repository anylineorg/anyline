...
public enum H2TypeMetadataAlias implements TypeMetadataAlias {
	...
	FLOAT4                             ("FLOAT4"                           ,StandardTypeMetadata.DOUBLE                             , 1, 0, 0),
	...
	TIMESTAMP_WITH_LOCAL_ZONE          ("TIMESTAMP WITH LOCAL TIME ZONE"   ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE           , 1, 1, 1),
	...
	TIMEZ                              ("TIMEZ"                            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE                , 1, 1, 1),
	...
	H2TypeMetadataAlias(String compatible, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale){
	...
	H2TypeMetadataAlias(String compatible, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale){
	...
	H2TypeMetadataAlias(String compatible, TypeMetadata standard){
		this.compatible = compatible;
		this.standard = standard;
	}

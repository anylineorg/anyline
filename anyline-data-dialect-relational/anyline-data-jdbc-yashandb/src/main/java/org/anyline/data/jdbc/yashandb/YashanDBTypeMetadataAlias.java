...
public enum YashanDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	BFILE                         ("BFILE"                          ,StandardTypeMetadata.BLOB                     ,   1,   1,   1,  -1,  -1,  -1),
	...
	BIT_VARYING                   ("BIT VARYING"                    ,StandardTypeMetadata.BLOB                     ,   1,   1,   1,  -1,  -1,  -1),
	BITMAP                        ("BITMAP"                         ,StandardTypeMetadata.BLOB                     ,   1,   1,   1,  -1,  -1,  -1),
	...
	BOX                           ("BOX"                            ,StandardTypeMetadata.BOX                      , "BOX2D"                          , "BOX2D"                               , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	BOX2D                         ("BOX2D"                          ,StandardTypeMetadata.BOX                      , "BOX2D"                          , "BOX2D"                               , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	BPCHAR                        ("BPCHAR"                         ,StandardTypeMetadata.BLOB                     ,   1,   1,   1,  -1,  -1,  -1),
	BPCHARBYTE                    ("BPCHARBYTE"                     ,StandardTypeMetadata.BLOB                     ,   1,   1,   1,  -1,  -1,  -1),
	BYTE                          ("BYTE"                           ,StandardTypeMetadata.TINYINT                  ,   1,   1,   1,  -1,  -1,  -1),
	...
	DATETIME                      ("DateTime"                       ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),
	DATETIME64                    ("DateTime"                       ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	DATETIME_WITH_TIME_ZONE       ("DATETIME WITH TIME ZONE"        ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),
	DATETIMEV2                    ("DATETIMEV2"                     ,StandardTypeMetadata.TIMESTAMP                ,   1,   2,   1,  -1,  -1,  -1),
	DATEV2                        ("DATEV2"                         ,StandardTypeMetadata.DATE                     ,   1,   1,   1,  -1,  -1,  -1),
	DEC                           ("DEC"                            ,StandardTypeMetadata.DECIMAL                  ,  -1,  -1,  -1,  -1,  -1,  -1),
	...
	GEO_POINT                     ("geo_point"                      ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	GEO_SHAPE                     ("geo_shape"                      ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	GEOGRAPHY                     ("GEOGRAPHY"                      ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	GEOGRAPHY_POINT               ("GEOGRAPHY_POINT"                ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	GEOMETRY                      ("GEOMETRY"                       ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	GEOMETRYCOLLECTION            ("GEOMETRYCOLLECTION"             ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	...
	INT2                          ("INT2"                           ,StandardTypeMetadata.SMALLINT                 ,   1,   1,   1,  -1,  -1,  -1),
	...
	INTERVAL_DAY                  ("INTERVAL DAY"                   ,StandardTypeMetadata.INTERVAL_DAY             ,   1,   2,   2,  -1,  -1,  -1),
	INTERVAL_DAY_HOUR             ("INTERVAL DAY TO HOUR"           ,StandardTypeMetadata.INTERVAL_DAY_HOUR        ,   1,   2,   2,  -1,  -1,  -1),
	INTERVAL_DAY_MINUTE           ("INTERVAL DAY TO MINUTE"         ,StandardTypeMetadata.INTERVAL_DAY_MINUTE      ,   1,   2,   2,  -1,  -1,  -1),
	...
	INTERVAL_HOUR                 ("INTERVAL HOUR"                  ,StandardTypeMetadata.INTERVAL_HOUR            ,   1,   2,   1,  -1,  -1,  -1),
	INTERVAL_HOUR_MINUTE          ("INTERVAL HOUR TO MINUTE"        ,StandardTypeMetadata.INTERVAL_HOUR_MINUTE     ,   1,   2,   2,  -1,  -1,  -1),
	INTERVAL_HOUR_SECOND          ("INTERVAL HOUR TO SECOND"        ,StandardTypeMetadata.INTERVAL_HOUR_SECOND     ,   1,   2,   2,  -1,  -1,  -1),
	INTERVAL_MINUTE               ("INTERVAL MINUTE"                ,StandardTypeMetadata.INTERVAL_MINUTE          ,   1,   2,   1,  -1,  -1,  -1),
	INTERVAL_MINUTE_SECOND        ("INTERVAL MINUTE TO SECOND"      ,StandardTypeMetadata.INTERVAL_MINUTE_SECOND   ,   1,   2,   2,  -1,  -1,  -1),
	INTERVAL_MONTH                ("INTERVAL MONTH"                 ,StandardTypeMetadata.INTERVAL_MONTH           ,   1,   2,   1,  -1,  -1,  -1),
	INTERVAL_SECOND               ("INTERVAL SECOND"                ,StandardTypeMetadata.INTERVAL_SECOND          ,   1,   2,   1,  -1,  -1,  -1),
	INTERVAL_YEAR                 ("INTERVAL YEAR"                  ,StandardTypeMetadata.INTERVAL_YEAR            ,   1,   2,   1,  -1,  -1,  -1),
	...
	LINE                          ("LINE"                           ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	LINESTRING                    ("LINESTRING"                     ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	LIST                          ("LIST"                           ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1,  -1,  -1,  -1),
	LONG                          ("long"                           ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1,  -1,  -1,  -1),
	LONG_TEXT                     ("LONG"                           ,StandardTypeMetadata.CLOB                     ,   1,   1,   1,  -1,  -1,  -1),
	...
	PG_SNAPSHOT                   ("PG_SNAPSHOT"                    ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	POINT                         ("POINT"                          ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	...
	RING                          ("RING"                           ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	...
	SERIAL2                       ("SERIAL2"                        ,StandardTypeMetadata.SMALLINT                 ,   1,   1,   1,  -1,  -1,  -1),
	...
	SHORT                         ("SHORT"                          ,StandardTypeMetadata.SMALLINT                 ,   1,   1,   1,  -1,  -1,  -1),
	...
	SIMPLE_INTEGER                ("SIMPLE_INTEGER"                 ,StandardTypeMetadata.SMALLINT                 ,   1,   1,   1,  -1,  -1,  -1),
	SimpleAggregateFunction       ("SimpleAggregateFunction"        ,StandardTypeMetadata.NONE                     ,  -1,  -1,  -1,  -1,  -1,  -1),
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),
	...
	SMALLSERIAL                   ("SMALLSERIAL"                    ,StandardTypeMetadata.SMALLINT                 ,   1,   1,   1,  -1,  -1,  -1),
	...
	ST_POINT                      ("ST_POINT"                       ,StandardTypeMetadata.ST_GEOMETRY              ,   1,   1,   1,  -1,  -1,  -1),
	STRING                        ("STRING"                         ,StandardTypeMetadata.CLOB                     ,   1,   1,   1,  -1,  -1,  -1),
	...
	TIME                          ("TIME"                           ,StandardTypeMetadata.TIME                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	TIME_TZ_UNCONSTRAINED         ("TIME TZ UNCONSTRAINED"          ,StandardTypeMetadata.TIME                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITHOUT_TIME_ZONE        ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITHOUT_ZONE             ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	TIME_UNCONSTRAINED            ("TIME_UNCONSTRAINED"             ,StandardTypeMetadata.TIME                     , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP"                      , "TIMESTAMP({S})"                      , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP WITH LOCAL TIME ZONE" , "TIMESTAMP({S}) WITH LOCAL TIME ZONE" , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.TIMESTAMP                ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.TIMESTAMP                , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	TIMETZ                        ("TIMETZ"                         ,StandardTypeMetadata.TIME                     ,   1,   1,   1,  -1,  -1,  -1),
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.TIME                     , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	...
	UINT16                        ("UInt16"                         ,StandardTypeMetadata.SMALLINT                 ,   1,   1,   1,  -1,  -1,  -1),
	...
	UINT64                        ("UInt64"                         ,StandardTypeMetadata.BIGINT                   ,   1,   1,   1,  -1,  -1,  -1),
	...
	UNSIGNED_LONG                 ("unsigned_long"                  ,StandardTypeMetadata.BIGINT                   ,   1,   1,   1,  -1,  -1,  -1),
	...
	VARBYTE                       ("VARBYTE"                        ,StandardTypeMetadata.BLOB                     ,   1,   1,   1,  -1,  -1,  -1),
	VARCHAR                       ("VARCHAR"                        ,StandardTypeMetadata.VARCHAR                  ,   0,   1,   1,  -1,  -1,  -1),
	VARCHAR2                      ("VARCHAR2"                       ,StandardTypeMetadata.VARCHAR                  ,   0,   1,   1,  -1,  -1,  -1),
	VARCHARBYTE                   ("VARCHARBYTE"                    ,StandardTypeMetadata.BLOB                     ,   1,   1,   1,  -1,  -1,  -1),
	...
	XML                           ("XML"                            ,StandardTypeMetadata.XML                      , "XMLTYPE"                        , "XMLTYPE"                             , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	XMLTYPE                       ("XMLTYPE"                        ,StandardTypeMetadata.XML                      , "XMLTYPE"                        , "XMLTYPE"                             , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	YEAR                          ("YEAR"                           ,StandardTypeMetadata.SMALLINT                 ,   1,   1,   1,  -1,  -1,  -1),
	...
	YashanDBTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
	...
	YashanDBTypeMetadataAlias(String input, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null , null, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	YashanDBTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}
	YashanDBTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, meta, formula, null, null, null, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	YashanDBTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null, null, null, ignoreLength, ignorePrecision, ignoreScale);
	}

	YashanDBTypeMetadataAlias(TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(null, standard, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale);
	}

	YashanDBTypeMetadataAlias(String input, TypeMetadata standard) {
		this.input = input;
		this.standard = standard;
	}

	YashanDBTypeMetadataAlias(TypeMetadata standard) {
		this.standard = standard;
	}

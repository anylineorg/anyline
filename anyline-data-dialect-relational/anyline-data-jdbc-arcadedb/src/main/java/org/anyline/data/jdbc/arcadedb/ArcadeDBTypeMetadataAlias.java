...
public enum ArcadeDBTypeMetadataAlias implements TypeMetadataAlias {
	...
	BIT_VARYING                   ("BIT VARYING"                    ,StandardTypeMetadata.BINARY       ,   0,   1,   1),
	...
	CLICKHOUSE_INT128             ("Int128"                         ,StandardTypeMetadata.LONG         ,  -1,  -1,  -1),
	...
	CLICKHOUSE_INT256             ("Int256"                         ,StandardTypeMetadata.LONG         ,  -1,  -1,  -1),
	INT256                        ("INT256"                         ,StandardTypeMetadata.LONG         ,  -1,  -1,  -1),
	INT32                         ("INT32"                          ,StandardTypeMetadata.INTEGER      ,   1,   1,   1),
	CLICKHOUSE_INT32              ("Int32"                          ,StandardTypeMetadata.INTEGER      ,   1,   1,   1),
	INT4                          ("INT4"                           ,StandardTypeMetadata.SHORT        ,   1,   1,   1),
	INT4RANGE                     ("INT4RANGE"                      ,StandardTypeMetadata.NONE         ,  -1,  -1,  -1),
	CLICKHOUSE_INT64              ("Int64"                          ,StandardTypeMetadata.LONG         ,  -1,  -1,  -1),
	INT64                         ("INT64"                          ,StandardTypeMetadata.LONG         ,  -1,  -1,  -1),
	CLICKHOUSE_INT8               ("Int8"                           ,StandardTypeMetadata.SHORT        ,   1,   1,   1),
	...
	JOIN                          ("join"                           ,StandardTypeMetadata.STRING       ,   1,   1,   1),
	...
	LVARCHAR                      ("LVARCHAR"                       ,StandardTypeMetadata.STRING       ,   1,   1,   1),
	...
	MEDIUMINT                     ("MEDIUMINT"                      ,StandardTypeMetadata.SHORT        ,   1,   1,   1),
	...
	NCLOB                         ("NCLOB"                          ,StandardTypeMetadata.BINARY       ,   0,   1,   1),
	...
	SHORT                         ("SHORT"                          ,StandardTypeMetadata.SHORT        ,   1,   1,   1),
	...
	SIMPLE_INTEGER                ("SIMPLE_INTEGER"                 ,StandardTypeMetadata.INTEGER      ,   1,   1,   1),
	...
	SMALLDECIMAL                  ("SMALLDECIMAL"                   ,StandardTypeMetadata.DECIMAL       ,  -1,  -1,  -1),
	SMALLFLOAT                    ("SMALLFLOAT"                     ,StandardTypeMetadata.FLOAT        ,   1,   2,   3),
	SMALLINT                      ("SMALLINT"                       ,StandardTypeMetadata.SHORT        ,   1,   1,   1),
	SMALLMONEY                    ("SMALLMONEY"                     ,StandardTypeMetadata.DECIMAL      ,   1,   0,   0),
	SMALLSERIAL                   ("SMALLSERIAL"                    ,StandardTypeMetadata.SHORT        ,   1,   1,   1),
	...
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.DATETIME     ,   1,   1,   2),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.DATETIME     ,   1,   1,   2),
	...
	TINYINT                       ("TINYINT"                        ,StandardTypeMetadata.SHORT        ,   1,   1,   1),
	...
	CLICKHOUSE_UINT128            ("UInt128"                        ,StandardTypeMetadata.LONG         ,  -1,  -1,  -1),
	CLICKHOUSE_UINT16             ("UInt16"                         ,StandardTypeMetadata.INTEGER      ,   1,   1,   1),
	CLICKHOUSE_UINT256            ("UInt256"                        ,StandardTypeMetadata.LONG         ,  -1,  -1,  -1),
	CLICKHOUSE_UINT32             ("UInt32"                         ,StandardTypeMetadata.INTEGER      ,   1,   1,   1),
	CLICKHOUSE_UINT64             ("UInt64"                         ,StandardTypeMetadata.LONG         ,  -1,  -1,  -1),
	...
	VARCHARBYTE                   ("VARCHARBYTE"                    ,StandardTypeMetadata.BINARY       ,   0,   1,   1),
	...
	ArcadeDBTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale){
		this.input = input;

...
public enum DorisTypeMetadataAlias implements TypeMetadataAlias {
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.DATETIME                      , "DATETIME" , "DATETIME({S})" , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2,  -1,  -1,  -1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.DATETIME                      , "DATETIME" , "DATETIME({S})" , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2,  -1,  -1,  -1),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , "DATETIME" , "DATETIME({S})" , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2,  -1,  -1,  -1),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.DATETIME                      , "DATETIME" , "DATETIME({S})" , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   , "DATETIME" , "DATETIME({S})" , null                       , "DATETIME_PRECISION" , null            ,   1,   2,   1,  -1,  -1,  -1),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   , "DATETIME" , "DATETIME({S})" , null                       , "DATETIME_PRECISION" , null            ,   1,   2,   1,  -1,  -1,  -1),

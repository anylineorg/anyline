...
public enum DorisTypeMetadataAlias implements TypeMetadataAlias {
	...
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.DOUBLE                        , null   , null            , null                       , "NUMERIC_PRECISION"  , "NUMERIC_SCALE" ,   1,   1,   1),
	...
	BINARY                        ("BINARY"                         ,StandardTypeMetadata.BINARY                        ,  -1,  -1,  -1),
	...
	BYTEA                         ("BYTEA"                          ,StandardTypeMetadata.VARBINARY                     ,  -1,  -1,  -1),
	...
	REAL                          ("REAL"                           ,StandardTypeMetadata.REAL                          ,  -1,  -1,  -1),
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.DATETIME                      , null   , "DATETIME({S})" , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.DATETIME                      , null   , "DATETIME({S})" , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.DATETIME                      , null   , "DATETIME({S})" , null                       , "DATETIME_PRECISION" , null            ,   1,   1,   2),

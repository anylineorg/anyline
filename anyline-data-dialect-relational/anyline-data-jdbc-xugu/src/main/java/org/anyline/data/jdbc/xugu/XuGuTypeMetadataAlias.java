...
public enum XuGuTypeMetadataAlias implements TypeMetadataAlias {
    ...
    BIGSERIAL               (StandardTypeMetadata.NUMERIC                ),
    BINARY                  (StandardTypeMetadata.BINARY                  ),
    BIT                     (StandardTypeMetadata.NUMERIC                ),
    BLOB                    (StandardTypeMetadata.BLOB                  ),
    BOOL                    (StandardTypeMetadata.NUMERIC                ),
    ...
    CURSOR                    (StandardTypeMetadata.CURSOR                  ),
    ...
    DECIMAL                 (StandardTypeMetadata.NUMERIC                ),
    ...
    GUID                    (StandardTypeMetadata.GUID)                 ,
    ...
    INT                     (StandardTypeMetadata.NUMERIC                ),
    INT2                    (StandardTypeMetadata.NUMERIC                ),
    INT4                    (StandardTypeMetadata.NUMERIC                ),
    INT8                    (StandardTypeMetadata.NUMERIC                ),
    ...
    MONEY                   (StandardTypeMetadata.NUMERIC                ),
    ...
    MEDIUMINT               (StandardTypeMetadata.NUMERIC                ),
    ...
    SERIAL                  (StandardTypeMetadata.NUMERIC                ),
    SERIAL2                 (StandardTypeMetadata.NUMERIC                ),
    SERIAL4                 (StandardTypeMetadata.NUMERIC                ),
    SERIAL8                 (StandardTypeMetadata.NUMERIC                ),
    SET                     (StandardTypeMetadata.ILLEGAL               ),
    SMALLDATETIME           (StandardTypeMetadata.TIMESTAMP             ),
    SMALLMONEY              (StandardTypeMetadata.NUMERIC                ),
    SMALLINT                (StandardTypeMetadata.SMALLINT                ),
    SMALLSERIAL             (StandardTypeMetadata.NUMERIC                ),
    SQL_VARIANT             (StandardTypeMetadata.ILLEGAL               ),
    SYSNAME                 (StandardTypeMetadata.ILLEGAL               ),
    SYS_REFCURSOR           (StandardTypeMetadata.SYS_REFCURSOR         ),
    ...
    XuGuTypeMetadataAlias(TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale){
        this.standard = standard;
        this.ignoreLength = ignoreLength;
        this.ignorePrecision = ignorePrecision;
        this.ignoreScale = ignoreScale;

...
public enum MSSQLTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.DATETIME2                     , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.DATETIMEOFFSET                , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.SMALLDATETIME                 , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	SMALLMONEY                    ("SMALLMONEY"                     ,StandardTypeMetadata.SMALLMONEY                    ,   1,   1,   1,  -1,  -1,  -1),
	SQL_DATETIMEOFFSET            ("SQL_DATETIMEOFFSET"             ,StandardTypeMetadata.SQL_DATETIMEOFFSET            , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),

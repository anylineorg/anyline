...
public enum MSSQLTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.DATETIME2                     , "DATETIME2" , "DATETIME2({S})" , null   , null   , null   ,   1,   1,   2,  -1,  -1,   7),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.DATETIMEOFFSET                , "DATETIME"  , "DATETIME({S})"  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   7),
	...
	HIERARCHYID                   ("HIERARCHYID"                    ,StandardTypeMetadata.HIERARCHYID                   ,   1,   1,   1,  -1,  -1,  -1),
	IMAGE                         ("IMAGE"                          ,StandardTypeMetadata.IMAGE                         ,   1,   1,   1,  -1,  -1,  -1),
	...
	NTEXT                         ("NTEXT"                          ,StandardTypeMetadata.NTEXT                         ,   1,   1,   1,  -1,  -1,  -1),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.SMALLDATETIME                 , "DATETIME"  , "DATETIME({S})"  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   7),
	SMALLMONEY                    ("SMALLMONEY"                     ,StandardTypeMetadata.SMALLMONEY                    ,   1,   1,   1,  -1,  -1,  -1),
	SQL_DATETIMEOFFSET            ("SQL_DATETIMEOFFSET"             ,StandardTypeMetadata.SQL_DATETIMEOFFSET            , "DATETIME"  , "DATETIME({S})"  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   7),
	SQL_VARIANT                   ("SQL_VARIANT"                    ,StandardTypeMetadata.SQL_VARIANT                   ,   1,   1,   1,  -1,  -1,  -1),
	SYSNAME                       ("SYSNAME"                        ,StandardTypeMetadata.SYSNAME                       ,   1,   1,   1,  -1,  -1,  -1),
	TEXT                          ("TEXT"                           ,StandardTypeMetadata.TEXT                          ,   1,   1,   1,  -1,  -1,  -1),
	TIME                          ("TIME"                           ,StandardTypeMetadata.TIME                          ,   1,   1,   1,  -1,  -1,   7),
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   2,  -1,  -1,   7),
	TINYINT                       ("TINYINT"                        ,StandardTypeMetadata.TINYINT                       ,   1,   1,   1,  -1,  -1,  -1),
	UNIQUEIDENTIFIER              ("UNIQUEIDENTIFIER"               ,StandardTypeMetadata.UNIQUEIDENTIFIER              ,   1,   1,   1,  -1,  -1,  -1),
	...
	BINARY_DOUBLE                 ("BINARY_DOUBLE"                  ,StandardTypeMetadata.NUMERIC                       ,   1,   0,   0,  -1,  -1,  -1),
	BINARY_FLOAT                  ("BINARY_FLOAT"                   ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1,  -1,  -1,  -1),
	...
	DATETIMEV2                    ("DATETIMEV2"                     ,StandardTypeMetadata.DATETIME                      ,   1,   1,   1,  -1,  -1,   7),
	...
	INTEGER                       ("INTEGER"                        ,StandardTypeMetadata.BIGINT                        ,   1,   1,   1,  -1,  -1,  -1),
	...
	MEDIUMBLOB                    ("MEDIUMBLOB"                     ,StandardTypeMetadata.VARBINARY                     ,   0,   1,   1,  -1,  -1,  -1),
	...
	NCLOB                         ("NCLOB"                          ,StandardTypeMetadata.VARBINARY                     ,   0,   1,   1,  -1,  -1,  -1),
	...
	SMALLINT                      ("SMALLINT"                       ,StandardTypeMetadata.INT32                         , "INT"       , "INT"            , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	SMALLSERIAL                   ("SMALLSERIAL"                    ,StandardTypeMetadata.INT32                         , "INT"       , "INT"            , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	...
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           ,   1,   1,   1,  -1,  -1,   7),
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           ,   1,   1,   1,  -1,  -1,   7),
	TIME_WITHOUT_TIME_ZONE        ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME_WITHOUT_TIME_ZONE        ,   1,   1,   1,  -1,  -1,   7),
	TIME_WITHOUT_ZONE             ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME_WITHOUT_TIME_ZONE        ,   1,   1,   1,  -1,  -1,   7),
	TIME_UNCONSTRAINED            ("TIME_UNCONSTRAINED"             ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   2,  -1,  -1,   7),
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      ,   1,   1,   2,  -1,  -1,   7),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP                     ,   1,   1,   2,  -1,  -1,   7),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   ,   1,   2,   1,  -1,  -1,   7),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   ,   1,   2,   1,  -1,  -1,   7),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   ,   1,   2,   1,  -1,  -1,   7),
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.NONE                          ,   1,  -1,  -1,  -1,  -1,  -1),
	TIMETZ                        ("TIMETZ"                         ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1,  -1,  -1,  -1),
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.TIME                          ,   1,   1,   1,  -1,  -1,   7),

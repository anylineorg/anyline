...
public enum MSSQLTypeMetadataAlias implements TypeMetadataAlias {
	...
	SMALLDATETIME                      ("SMALLDATETIME"                    ,StandardTypeMetadata.SMALLDATETIME                      , 1, 1, 1),
	SMALLMONEY                         ("SMALLMONEY"                       ,StandardTypeMetadata.SMALLMONEY                         , 1, 1, 1),
	SQL_DATETIMEOFFSET                 ("SQL_DATETIMEOFFSET"               ,StandardTypeMetadata.SQL_DATETIMEOFFSET                 , 1, 1, 1),
	...
	JSON                               ("JSON"                             ,StandardTypeMetadata.ILLEGAL                            , -1, -1, -1),

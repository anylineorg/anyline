...
public enum MSSQLTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.DATETIME2                     , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.DATETIMEOFFSET                , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2),
	...
	HIERARCHYID                   ("HIERARCHYID"                    ,StandardTypeMetadata.HIERARCHYID                   ,   1,   1,   1),
	...
	NTEXT                         ("NTEXT"                          ,StandardTypeMetadata.NTEXT                         ,   1,   1,   1),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.SMALLDATETIME                 , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2),
	SMALLMONEY                    ("SMALLMONEY"                     ,StandardTypeMetadata.SMALLMONEY                    ,   1,   1,   1),
	SQL_DATETIMEOFFSET            ("SQL_DATETIMEOFFSET"             ,StandardTypeMetadata.SQL_DATETIMEOFFSET            , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2),
	SQL_VARIANT                   ("SQL_VARIANT"                    ,StandardTypeMetadata.SQL_VARIANT                   ,   1,   1,   1),
	SYSNAME                       ("SYSNAME"                        ,StandardTypeMetadata.SYSNAME                       ,   1,   1,   1),
	...
	UNIQUEIDENTIFIER              ("UNIQUEIDENTIFIER"               ,StandardTypeMetadata.UNIQUEIDENTIFIER              ,   1,   1,   1),
	...
	BINARY_DOUBLE                 ("BINARY_DOUBLE"                  ,StandardTypeMetadata.NUMERIC                       ,   1,   0,   0),
	BINARY_FLOAT                  ("BINARY_FLOAT"                   ,StandardTypeMetadata.FLOAT                         ,   1,   2,   1),
	...
	BLOB                          ("BLOB"                           ,StandardTypeMetadata.VARBINARY                     ,   0,   1,   1),
	BOOL                          ("BOOL"                           ,StandardTypeMetadata.BIT_INT                       ,   1,   1,   1),
	...
	INTEGER                       ("INTEGER"                        ,StandardTypeMetadata.BIGINT                        ,   1,   1,   1),
	...
	MEDIUMBLOB                    ("MEDIUMBLOB"                     ,StandardTypeMetadata.VARBINARY                     ,   0,   1,   1),
	...
	NCLOB                         ("NCLOB"                          ,StandardTypeMetadata.VARBINARY                     ,   0,   1,   1),
	...
	SMALLINT                      ("SMALLINT"                       ,StandardTypeMetadata.INT32                         , "INT"      , "INT"           , null   , null   , null   ,   1,   1,   1),
	SMALLSERIAL                   ("SMALLSERIAL"                    ,StandardTypeMetadata.INT32                         , "INT"      , "INT"           , null   , null   , null   ,   1,   1,   1),
	...
	MSSQLTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this.input = input;

...
public enum MSSQLTypeMetadataAlias implements TypeMetadataAlias {
	...
	BIT                       ("BIT"                       ,StandardTypeMetadata.BIT_INT              ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	CHAR                      ("CHAR"                      ,StandardTypeMetadata.CHAR                 ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	DATE                      ("DATE"                      ,StandardTypeMetadata.DATE                 ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	DATETIME                  ("DATETIME"                  ,StandardTypeMetadata.DATETIME             , "DATETIME"  , "DATETIME({S})"  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   7,   0,   0),
	DATETIME2                 ("DATETIME2"                 ,StandardTypeMetadata.DATETIME2            , "DATETIME2" , "DATETIME2({S})" , null   , null   , null   ,   1,   1,   2,  -1,  -1,   7,   0,   0),
	DATETIMEOFFSET            ("DATETIMEOFFSET"            ,StandardTypeMetadata.DATETIMEOFFSET       , "DATETIME"  , "DATETIME({S})"  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   7,   0,   0),
	DECIMAL                   ("DECIMAL"                   ,StandardTypeMetadata.DECIMAL              ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	FLOAT                     ("FLOAT"                     ,StandardTypeMetadata.FLOAT                ,   1,   2,   1,  -1,  -1,  -1,  -1,  -1),
	GEOGRAPHY                 ("GEOGRAPHY"                 ,StandardTypeMetadata.GEOGRAPHY            ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	HIERARCHYID               ("HIERARCHYID"               ,StandardTypeMetadata.HIERARCHYID          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	IMAGE                     ("IMAGE"                     ,StandardTypeMetadata.IMAGE                ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	NTEXT                     ("NTEXT"                     ,StandardTypeMetadata.NTEXT                ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SMALLDATETIME             ("SMALLDATETIME"             ,StandardTypeMetadata.SMALLDATETIME        , "DATETIME"  , "DATETIME({S})"  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   7,   0,   0),
	SMALLMONEY                ("SMALLMONEY"                ,StandardTypeMetadata.SMALLMONEY           ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	SQL_DATETIMEOFFSET        ("SQL_DATETIMEOFFSET"        ,StandardTypeMetadata.SQL_DATETIMEOFFSET   , "DATETIME"  , "DATETIME({S})"  , null   , null   , null   ,   1,   1,   2,  -1,  -1,   7,   0,   0),
	SQL_VARIANT               ("SQL_VARIANT"               ,StandardTypeMetadata.SQL_VARIANT          ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	SYSNAME                   ("SYSNAME"                   ,StandardTypeMetadata.SYSNAME              ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TEXT                      ("TEXT"                      ,StandardTypeMetadata.TEXT                 ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	TIME                      ("TIME"                      ,StandardTypeMetadata.TIME                 ,   1,   1,   1,  -1,  -1,   7,   0,   0),
	TIMESTAMP                 ("TIMESTAMP"                 ,StandardTypeMetadata.TIMESTAMP            , "TIMESTAMP" , "TIMESTAMP"      , null   , null   , null   ,   1,   1,   2,  -1,  -1,   7,   0,   0),
	TINYINT                   ("TINYINT"                   ,StandardTypeMetadata.TINYINT              ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	UNIQUEIDENTIFIER          ("UNIQUEIDENTIFIER"          ,StandardTypeMetadata.UNIQUEIDENTIFIER     ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	BINARY_DOUBLE             ("BINARY_DOUBLE"             ,StandardTypeMetadata.NUMERIC              ,   1,   0,   0,  -1,  -1,  -1,  -1,  -1),
	BINARY_FLOAT              ("BINARY_FLOAT"              ,StandardTypeMetadata.FLOAT                ,   1,   2,   1,  -1,  -1,  -1,  -1,  -1),
	...
	BLOB                      ("BLOB"                      ,StandardTypeMetadata.VARBINARY            ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	DATETIMEV2                ("DATETIMEV2"                ,StandardTypeMetadata.DATETIME             ,   1,   1,   1,  -1,  -1,   7,   0,   0),
	...
	INTEGER                   ("INTEGER"                   ,StandardTypeMetadata.BIGINT               ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	LONGBLOB                  ("LONGBLOB"                  ,StandardTypeMetadata.VARBINARY            ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	MEDIUMBLOB                ("MEDIUMBLOB"                ,StandardTypeMetadata.VARBINARY            ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	NCLOB                     ("NCLOB"                     ,StandardTypeMetadata.VARBINARY            ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	SMALLINT                  ("SMALLINT"                  ,StandardTypeMetadata.INT32                , "INT"       , "INT"            , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	SMALLSERIAL               ("SMALLSERIAL"               ,StandardTypeMetadata.INT32                , "INT"       , "INT"            , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	TIME_TZ_UNCONSTRAINED     ("TIME TZ UNCONSTRAINED"     ,StandardTypeMetadata.TIME                 , "TIME"      , "TIME"           , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,   0,   0),
	TIME_UNCONSTRAINED        ("TIME_UNCONSTRAINED"        ,StandardTypeMetadata.TIME                 , "TIME"      , "TIME"           , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1,   0,   0),
	TIMESTAMP_NTZ             ("TIMESTAMP_NTZ"             ,StandardTypeMetadata.TIMESTAMP            , "TIMESTAMP" , "TIMESTAMP"      , null   , null   , null   ,   1,   2,   1,  -1,  -1,   7,   0,   0),
	TIMESTAMPTZ               ("TIMESTAMPTZ"               ,StandardTypeMetadata.TIMESTAMP            , "TIMESTAMP" , "TIMESTAMP"      , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1,   0,   0),
	TIMETZ                    ("TIMETZ"                    ,StandardTypeMetadata.TIME                 ,   1,   1,   1,  -1,  -1,  -1,   0,   0),
	TIMEZ                     ("TIMEZ"                     ,StandardTypeMetadata.TIME                 , "TIME"      , "TIME"           , null   , null   , null   ,   1,   1,   1,  -1,  -1,   7,   0,   0),
	TINYBLOB                  ("TINYBLOB"                  ,StandardTypeMetadata.VARBINARY            ,   0,   1,   1,  -1,  -1,  -1,  -1,  -1),
	...
	MSSQLTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
		this.input = input;
	...
	MSSQLTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
		this.standard = standard;
		this.meta = meta;
		this.formula = formula;
	...
	MSSQLTypeMetadataAlias(String input, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, null , null, lengthRefer, precisionRefer, scaleRefer, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	MSSQLTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this(input, standard, null, null, null, null, null,  ignoreLength, ignorePrecision, ignoreScale, maxLength, maxPrecision, maxScale);
	}

	MSSQLTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale, int supportTimeZone, int supportLocalTimeZone) {
	...
	MSSQLTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, int ignoreLength, int ignorePrecision, int ignoreScale) {
		this(input, standard, meta, formula, null, null, null, ignoreLength, ignorePrecision, ignoreScale, -1, -1, -1);
	}

	MSSQLTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale) {
	...
	MSSQLTypeMetadataAlias(String input, TypeMetadata standard) {
		this.input = input;
		this.standard = standard;
	}

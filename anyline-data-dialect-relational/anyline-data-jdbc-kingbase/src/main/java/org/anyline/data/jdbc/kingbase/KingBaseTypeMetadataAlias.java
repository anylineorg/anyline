...
public enum KingBaseTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.DATETIME                      , "DATETIME"                  , "DATETIME({S})"             , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                 , "TIMESTAMP({S})"            , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),

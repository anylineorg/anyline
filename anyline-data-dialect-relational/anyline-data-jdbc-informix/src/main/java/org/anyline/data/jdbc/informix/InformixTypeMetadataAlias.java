...
public enum InformixTypeMetadataAlias implements TypeMetadataAlias {
	...
	SMALLFLOAT                         ("SMALLFLOAT"                       ,StandardTypeMetadata.SMALLFLOAT                         , 1, 0, 1),
	...
	InformixTypeMetadataAlias(String compatible, TypeMetadata standard, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale){
	...
	InformixTypeMetadataAlias(String compatible, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale){
	...
	InformixTypeMetadataAlias(String compatible, TypeMetadata standard){
		this.compatible = compatible;
		this.standard = standard;
	}

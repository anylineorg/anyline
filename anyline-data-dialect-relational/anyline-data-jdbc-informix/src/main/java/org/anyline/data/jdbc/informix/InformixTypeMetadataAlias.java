...
public enum InformixTypeMetadataAlias implements TypeMetadataAlias {
	...
	DECIMAL                       ("DECIMAL"                        ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   2),
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   2),
	...
	DEC                           ("DEC"                            ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   2),
	DECFLOAT                      ("DECFLOAT"                       ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	DECIMAL128                    ("Decimal128"                     ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   2),
	DECIMAL256                    ("Decimal256"                     ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   2),
	DECIMAL32                     ("Decimal32"                      ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   2),
	DECIMAL64                     ("Decimal64"                      ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   2),
	...
	NUMBER                        ("NUMBER"                         ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   2),
	NUMERIC                       ("NUMERIC"                        ,StandardTypeMetadata.NUMERIC                       ,   1,   0,   2),
	...
	SMALLDECIMAL                  ("SMALLDECIMAL"                   ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   2),
	SMALLINT                      ("SMALLINT"                       ,StandardTypeMetadata.INT32                         , "INT"      , "INT"           , null   , null   , null   ,   1,   1,   1),
	SMALLMONEY                    ("SMALLMONEY"                     ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   2),
	...
	YEAR                          ("YEAR"                           ,StandardTypeMetadata.DATETIME                      , "DATETIME" , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2),

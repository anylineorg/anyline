...
public enum ClickHouseTypeMetadataAlias implements TypeMetadataAlias {
	...
	CLICKHOUSE_DATE32             ("DATE32"                         ,StandardTypeMetadata.CLICKHOUSE_DATE32             , "Date32"     , null   , null   , null   , null   ,   1,   1,   1),
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.DATETIME                      ,   1,   1,   1),
	CLICKHOUSE_DATETIME64         ("DATETIME64"                     ,StandardTypeMetadata.CLICKHOUSE_DATETIME64         , "DateTime64" , null   , null   , null   , null   ,   1,   1,   1),
	DECIMAL                       ("DECIMAL"                        ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   0),
	CLICKHOUSE_DECIMAL128         ("DECIMAL128"                     ,StandardTypeMetadata.CLICKHOUSE_DECIMAL128         , "Decimal128" , null   , null   , null   , null   ,   1,   0,   2),
	CLICKHOUSE_DECIMAL256         ("DECIMAL256"                     ,StandardTypeMetadata.CLICKHOUSE_DECIMAL256         , "Decimal256" , null   , null   , null   , null   ,   1,   0,   2),
	CLICKHOUSE_DECIMAL32          ("DECIMAL32"                      ,StandardTypeMetadata.CLICKHOUSE_DECIMAL32          , "Decimal32"  , null   , null   , null   , null   ,   1,   0,   2),
	CLICKHOUSE_DECIMAL64          ("DECIMAL64"                      ,StandardTypeMetadata.CLICKHOUSE_DECIMAL64          , "Decimal64"  , null   , null   , null   , null   ,   1,   0,   2),
	ENUM                          ("ENUM"                           ,StandardTypeMetadata.ENUM                          ,   1,   1,   1),
	FIXEDSTRING                   ("FixedString"                    ,StandardTypeMetadata.FixedString                   ,   0,   1,   1),
	CLICKHOUSE_FLOAT32            ("FLOAT32"                        ,StandardTypeMetadata.CLICKHOUSE_FLOAT32            , "Float32"    , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_FLOAT64            ("FLOAT64"                        ,StandardTypeMetadata.CLICKHOUSE_FLOAT64            , "Float64"    , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_INT128             ("INT128"                         ,StandardTypeMetadata.CLICKHOUSE_INT128             , "Int128"     , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_INT16              ("INT16"                          ,StandardTypeMetadata.CLICKHOUSE_INT16              , "Int16"      , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_INT256             ("INT256"                         ,StandardTypeMetadata.CLICKHOUSE_INT256             , "Int256"     , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_INT32              ("INT32"                          ,StandardTypeMetadata.CLICKHOUSE_INT32              , "Int32"      , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_INT64              ("INT64"                          ,StandardTypeMetadata.CLICKHOUSE_INT64              , "Int64"      , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_INT8               ("INT8"                           ,StandardTypeMetadata.CLICKHOUSE_INT8               , "Int8"       , null   , null   , null   , null   ,   1,   1,   1),
	...
	CLICKHOUSE_UINT128            ("UINT128"                        ,StandardTypeMetadata.CLICKHOUSE_UINT128            , "UInt128"    , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_UINT16             ("UINT16"                         ,StandardTypeMetadata.CLICKHOUSE_UINT16             , "UInt16"     , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_UINT256            ("UINT256"                        ,StandardTypeMetadata.CLICKHOUSE_UINT256            , "UInt256"    , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_UINT32             ("UINT32"                         ,StandardTypeMetadata.CLICKHOUSE_UINT32             , "UInt32"     , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_UINT64             ("UINT64"                         ,StandardTypeMetadata.CLICKHOUSE_UINT64             , "UInt64"     , null   , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_UINT8              ("UINT8"                          ,StandardTypeMetadata.CLICKHOUSE_UINT8              , "UInt8"      , null   , null   , null   , null   ,   1,   1,   1),
	...
	BIGINT                        ("BIGINT"                         ,StandardTypeMetadata.CLICKHOUSE_INT64              , "Int64"      , null   , null   , null   , null   ,   1,   1,   1),
	BIGSERIAL                     ("BIGSERIAL"                      ,StandardTypeMetadata.CLICKHOUSE_INT64              , "Int64"      , null   , null   , null   , null   ,   1,   1,   1),
	BINARY                        ("BINARY"                         ,StandardTypeMetadata.ILLEGAL                       ,  -1,  -1,  -1),
	BINARY_DOUBLE                 ("BINARY_DOUBLE"                  ,StandardTypeMetadata.CLICKHOUSE_FLOAT64            , "Float64"    , null   , null   , null   , null   ,   1,   1,   1),
	BINARY_FLOAT                  ("BINARY_FLOAT"                   ,StandardTypeMetadata.CLICKHOUSE_FLOAT32            , "Float32"    , null   , null   , null   , null   ,   1,   1,   1),
	...
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.CLICKHOUSE_FLOAT64            , "Float64"    , null   , null   , null   , null   ,   1,   1,   1),
	...
	FLOAT                         ("FLOAT"                          ,StandardTypeMetadata.CLICKHOUSE_FLOAT32            , "Float32"    , null   , null   , null   , null   ,   1,   1,   1),
	FLOAT4                        ("FLOAT4"                         ,StandardTypeMetadata.CLICKHOUSE_FLOAT32            , "Float32"    , null   , null   , null   , null   ,   1,   1,   1),
	FLOAT8                        ("FLOAT8"                         ,StandardTypeMetadata.CLICKHOUSE_FLOAT32            , "Float32"    , null   , null   , null   , null   ,   1,   1,   1),
	...
	INT                           ("INT"                            ,StandardTypeMetadata.CLICKHOUSE_INT32              , "Int32"      , null   , null   , null   , null   ,   1,   1,   1),
	INT128                        ("INT128"                         ,StandardTypeMetadata.CLICKHOUSE_INT128             , "Int128"     , null   , null   , null   , null   ,   1,   1,   1),
	INT16                         ("INT16"                          ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	INT2                          ("INT2"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	INT256                        ("INT256"                         ,StandardTypeMetadata.CLICKHOUSE_INT256             , "Int256"     , null   , null   , null   , null   ,   1,   1,   1),
	INT32                         ("INT32"                          ,StandardTypeMetadata.CLICKHOUSE_INT32              , "Int32"      , null   , null   , null   , null   ,   1,   1,   1),
	INT4                          ("INT4"                           ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	INT4RANGE                     ("INT4RANGE"                      ,StandardTypeMetadata.NONE                          ,  -1,  -1,  -1),
	INT64                         ("INT64"                          ,StandardTypeMetadata.CLICKHOUSE_INT64              , "Int64"      , null   , null   , null   , null   ,   1,   1,   1),
	INT8                          ("INT8"                           ,StandardTypeMetadata.CLICKHOUSE_INT8               , "Int8"       , null   , null   , null   , null   ,   1,   1,   1),
	...
	REAL                          ("REAL"                           ,StandardTypeMetadata.CLICKHOUSE_FLOAT32            , "Float32"    , null   , null   , null   , null   ,   1,   1,   1),

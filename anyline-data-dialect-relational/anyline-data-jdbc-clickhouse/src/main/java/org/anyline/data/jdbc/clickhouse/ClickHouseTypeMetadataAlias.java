...
public enum ClickHouseTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME                      ("DATETIME"                       ,StandardTypeMetadata.CLICKHOUSE_DATETIME64         ,   1,   1,   2),
	CLICKHOUSE_DATETIME64         ("DATETIME64"                     ,StandardTypeMetadata.CLICKHOUSE_DATETIME64         , "DateTime64" , "DateTime64"    , null   , null   , null   ,   1,   1,   2),
	DECIMAL                       ("DECIMAL"                        ,StandardTypeMetadata.DECIMAL                       ,   1,   0,   0),
	CLICKHOUSE_DECIMAL128         ("DECIMAL128"                     ,StandardTypeMetadata.CLICKHOUSE_DECIMAL128         , "Decimal128" , "Decimal128"    , null   , null   , null   ,   1,   0,   2),
	CLICKHOUSE_DECIMAL256         ("DECIMAL256"                     ,StandardTypeMetadata.CLICKHOUSE_DECIMAL256         , "Decimal256" , "Decimal256"    , null   , null   , null   ,   1,   0,   2),
	CLICKHOUSE_DECIMAL32          ("DECIMAL32"                      ,StandardTypeMetadata.CLICKHOUSE_DECIMAL32          , "Decimal32"  , "Decimal32"     , null   , null   , null   ,   1,   0,   2),
	CLICKHOUSE_DECIMAL64          ("DECIMAL64"                      ,StandardTypeMetadata.CLICKHOUSE_DECIMAL64          , "Decimal64"  , "Decimal64"     , null   , null   , null   ,   1,   0,   2),
	...
	INT                           ("INT"                            ,StandardTypeMetadata.INT                           , "Int32"      , "Int32"         , null   , null   , null   ,   1,   1,   1),
	...
	DATETIME2                     ("DATETIME2"                      ,StandardTypeMetadata.DATETIME                      ,   1,   1,   2),
	DATETIMEOFFSET                ("DATETIMEOFFSET"                 ,StandardTypeMetadata.DATETIME                      ,   1,   1,   2),
	...
	SMALLDATETIME                 ("SMALLDATETIME"                  ,StandardTypeMetadata.DATETIME                      ,   1,   1,   2),
	...
	TIME                          ("TIME"                           ,StandardTypeMetadata.DATETIME                      ,   1,   1,   2),
	...
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.DATETIME                      ,   1,   1,   2),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.DATETIME                      ,   1,   1,   2),
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.DATETIME                      ,   1,   1,   2),
	...
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.DATETIME                      ,   1,   1,   2),

...
public enum ClickHouseTypeMetadataAlias implements TypeMetadataAlias {
	...
	BIT                           ("BIT"                            ,StandardTypeMetadata.CLICKHOUSE_INT8           ,   1,   1,   1),
	BIT_VARYING                   ("BIT VARYING"                    ,StandardTypeMetadata.NONE                      ,  -1,  -1,  -1),
	BITMAP                        ("BITMAP"                         ,StandardTypeMetadata.NONE                      ,  -1,  -1,  -1),
	BLOB                          ("BLOB"                           ,StandardTypeMetadata.STRING                    ,   0,   1,   1),
	BOOL                          ("BOOL"                           ,StandardTypeMetadata.CLICKHOUSE_INT8           ,   1,   1,   1),
	BOOLEAN                       ("BOOLEAN"                        ,StandardTypeMetadata.CLICKHOUSE_INT8           ,   1,   1,   1),
	...
	BYTE                          ("BYTE"                           ,StandardTypeMetadata.CLICKHOUSE_INT8           ,   1,   1,   1),
	BYTEA                         ("BYTEA"                          ,StandardTypeMetadata.STRING                    ,   0,   1,   1),
	...
	CLICKHOUSE_DATETIME64         ("DateTime"                       ,StandardTypeMetadata.CLICKHOUSE_DATETIME64     ,   1,   1,   1),
	...
	JSONB                         ("JSONB"                          ,StandardTypeMetadata.STRING                    ,   0,   1,   1),
	...
	LONGBLOB                      ("LONGBLOB"                       ,StandardTypeMetadata.STRING                    ,   0,   1,   1),
	...
	MEDIUMBLOB                    ("MEDIUMBLOB"                     ,StandardTypeMetadata.STRING                    ,   0,   1,   1),
	...
	SERIAL                        ("SERIAL"                         ,StandardTypeMetadata.CLICKHOUSE_INT32          ,   1,   0,   0),
	SERIAL2                       ("SERIAL2"                        ,StandardTypeMetadata.CLICKHOUSE_INT16          ,   1,   0,   0),
	SERIAL4                       ("SERIAL4"                        ,StandardTypeMetadata.CLICKHOUSE_INT32          ,   1,   0,   0),
	SERIAL8                       ("SERIAL8"                        ,StandardTypeMetadata.CLICKHOUSE_INT64          ,   1,   0,   0),
	SET                           ("SET"                            ,StandardTypeMetadata.NONE                      ,  -1,  -1,  -1),
	SHAPE                         ("shape"                          ,StandardTypeMetadata.NONE                      ,  -1,  -1,  -1),
	SHORT                         ("SHORT"                          ,StandardTypeMetadata.CLICKHOUSE_INT16          ,   1,   1,   1),
	SIGNTYPE                      ("SIGNTYPE"                       ,StandardTypeMetadata.NONE                      ,  -1,  -1,  -1),
	SIMPLE_DOUBLE                 ("SIMPLE_DOUBLE"                  ,StandardTypeMetadata.CLICKHOUSE_FLOAT64      ,  -1,  -1,  -1),
	SIMPLE_FLOAT                  ("SIMPLE_FLOAT"                   ,StandardTypeMetadata.CLICKHOUSE_FLOAT32        ,   1,   1,   1),
	SIMPLE_INTEGER                ("SIMPLE_INTEGER"                 ,StandardTypeMetadata.CLICKHOUSE_INT32          ,   1,   1,   1),
	...
	SMALLFLOAT                    ("SMALLFLOAT"                     ,StandardTypeMetadata.CLICKHOUSE_FLOAT32        ,  -1,  -1,  -1),
	...
	TIMESTAMP_WITH_ZONE           ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.DATETIME                  ,   1,   1,   1),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.DATETIME                  ,   1,   1,   1),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.DATETIME                  ,   1,   1,   1),
	TIMESTAMP_NTZ                 ("TIMESTAMP_NTZ"                  ,StandardTypeMetadata.DATETIME                  ,   1,   1,   1),
	TIMESTAMPTZ                   ("TIMESTAMPTZ"                    ,StandardTypeMetadata.DATETIME                  ,   1,   1,   1),
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.DATETIME                  , "DATETIME"   , "DATETIME({S})" , null   , null   , null   ,   1,   1,   2),
	TINYBLOB                      ("TINYBLOB"                       ,StandardTypeMetadata.STRING                    ,   0,   1,   1),
	TINYINT                       ("TINYINT"                        ,StandardTypeMetadata.CLICKHOUSE_INT8           ,   1,   0,   0),
	...
	VARBINARY                     ("VARBINARY"                      ,StandardTypeMetadata.STRING                    ,   0,   1,   1),
	VARBIT                        ("VARBIT"                         ,StandardTypeMetadata.STRING                    ,   0,   1,   1),

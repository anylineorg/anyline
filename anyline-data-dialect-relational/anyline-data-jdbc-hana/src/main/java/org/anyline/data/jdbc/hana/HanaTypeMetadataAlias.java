...
public enum HanaTypeMetadataAlias implements TypeMetadataAlias {
	...
	DATETIME64                    ("DateTime"                       ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                 , "TIMESTAMP({S}) "                , null   , null   , null   ,  -1,  -1,  -1),
	...
	TIME_TZ_UNCONSTRAINED         ("TIME TZ UNCONSTRAINED"          ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIMESTAMP"                 , "TIMESTAMP({S}) "                , null   , null   , null   ,  -1,  -1,  -1),
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIMESTAMP"                 , "TIMESTAMP({S}) "                , null   , null   , null   ,   1,   1,   1),
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIMESTAMP"                 , "TIMESTAMP({S}) "                , null   , null   , null   ,   1,   1,   1),

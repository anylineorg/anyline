...
public class HanaAdapter extends OracleGenusAdapter implements JDBCAdapter, InitializingBean {
	...
	public long insert(DataRuntime runtime, String random, Object data, ConfigStore configs, Run run, String[] pks){
		return super.insert(runtime, random, data, configs, run, pks, true);
	}

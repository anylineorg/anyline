...
public class DMAdapter extends OracleGenusAdapter implements JDBCAdapter, InitializingBean {
	...
	public List<Run> buildQueryIndexsRun(DataRuntime runtime, Table table, String name){
		...
		if(BasicUtil.isNotEmpty(schema)){
			...
			has_where = true;
			builder.append(" INDEX_OWNER = '").append(schema).append("'\n");
		}
		if(BasicUtil.isNotEmpty(tab)){
			...
			builder.append(" TABLE_NAME = '").append(tab).append("'\n");
		}
		if(BasicUtil.isNotEmpty(name)){
			...
			builder.append(" INDEX_NAME = '").append(name).append("'\n");
		}
		return runs;
	}

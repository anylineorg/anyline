...
public enum DMTypeMetadataAlias implements TypeMetadataAlias {
	...
	TIME                          ("TIME"                           ,StandardTypeMetadata.TIME                          , "TIME"                           , "TIME({S})"                           , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIME WITH TIME ZONE"            , "TIME WITH TIME ZONE"                 , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIME WITH TIME ZONE"            , "TIME({S}) WITH TIME ZONE"            , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S})"                      , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP_WITH_LOCAL_ZONE     , "TIMESTAMP WITH LOCAL TIME ZONE" , "TIMESTAMP({S}) WITH LOCAL TIME ZONE" , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),
	...
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),
	...
	TIME_TZ_UNCONSTRAINED         ("TIME TZ UNCONSTRAINED"          ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIME WITH TIME ZONE"            , "TIME({S}) WITH TIME ZONE"            , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	TIME_WITHOUT_TIME_ZONE        ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME_WITHOUT_TIME_ZONE        , "TIME"                           , "TIME({S})"                           , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	TIME_WITHOUT_ZONE             ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME_WITHOUT_TIME_ZONE        , "TIME"                           , "TIME({S})"                           , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),
	TIME_UNCONSTRAINED            ("TIME_UNCONSTRAINED"             ,StandardTypeMetadata.TIME                          , "TIME"                           , "TIME({S})"                           , null   , null   , null   ,   1,   1,   1,  -1,  -1,  -1),
	...
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.TIME                          , "TIME WITH TIME ZONE"            , "TIME({S}) WITH TIME ZONE"            , null   , null   , null   ,   1,   1,   2,  -1,  -1,  -1),

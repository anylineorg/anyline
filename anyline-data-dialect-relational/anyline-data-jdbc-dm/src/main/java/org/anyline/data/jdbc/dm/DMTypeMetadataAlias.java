...
public enum DMTypeMetadataAlias implements TypeMetadataAlias {
	...
	BOOLEAN                       ("BOOLEAN"                        ,StandardTypeMetadata.BIT_BOOLEAN                   ,   1,   1,   1,  -1,  -1,  -1),
	...
	DOUBLE                        ("DOUBLE"                         ,StandardTypeMetadata.NUMERIC                       ,   1,   0,   0,  -1,  -1,  -1),
	...
	INTERVAL_SECOND               ("INTERVAL SECOND"                ,StandardTypeMetadata.INTERVAL_SECOND               , "INTERVAL SECOND"                , "INTERVAL SECOND({P},{S})"            , null   , null   , null   ,   1,   2,   3,  -1,  -1,  -1),
	...
	NVARCHAR2                     ("NVARCHAR2"                      ,StandardTypeMetadata.VARCHAR2                      ,   0,   1,   1,  -1,  -1,  -1),
	...
	TIME                          ("TIME"                           ,StandardTypeMetadata.TIME                          , "TIME"                           , "TIME({S})"                           , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TIME_WITH_ZONE                ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIME WITH TIME ZONE"            , "TIME WITH TIME ZONE"                 , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TIME_WITH_TIME_ZONE           ("TIME WITH TIME ZONE"            ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIME WITH TIME ZONE"            , "TIME({S}) WITH TIME ZONE"            , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TIMESTAMP                     ("TIMESTAMP"                      ,StandardTypeMetadata.TIMESTAMP                     , "TIMESTAMP"                      , "TIMESTAMP({S})"                      , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TIMESTAMP_WITH_LOCAL_ZONE     ("TIMESTAMP WITH LOCAL TIME ZONE" ,StandardTypeMetadata.TIMESTAMP_WITH_LOCAL_ZONE     , "TIMESTAMP WITH LOCAL TIME ZONE" , "TIMESTAMP({S}) WITH LOCAL TIME ZONE" , null   , null   , null   ,   1,   2,   2,  -1,  -1,   9),
	...
	TIMESTAMP_WITH_TIME_ZONE      ("TIMESTAMP WITH TIME ZONE"       ,StandardTypeMetadata.TIMESTAMP_WITH_TIME_ZONE      , "TIMESTAMP WITH TIME ZONE"       , "TIMESTAMP({S}) WITH TIME ZONE"       , null   , null   , null   ,   1,   2,   2,  -1,  -1,   9),
	...
	DEC                           ("DEC"                            ,StandardTypeMetadata.DEC                           ,   1,   0,   0,  -1,  -1,  -1),
	...
	INT128                        ("INT128"                         ,StandardTypeMetadata.INT128                        ,   1,   1,   1,  -1,  -1,  -1),
	...
	INTERVAL_DAY                  ("INTERVAL DAY"                   ,StandardTypeMetadata.INTERVAL_DAY                  , "INTERVAL DAY"                   , "INTERVAL DAY({P})"                   , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	INTERVAL_DAY_HOUR             ("INTERVAL DAY TO HOUR"           ,StandardTypeMetadata.INTERVAL_DAY_HOUR             , "INTERVAL DAY TO HOUR"           , "INTERVAL DAY({P}) TO HOUR"           , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	INTERVAL_DAY_MINUTE           ("INTERVAL DAY TO MINUTE"         ,StandardTypeMetadata.INTERVAL_DAY_MINUTE           , "INTERVAL DAY TO MINUTE"         , "INTERVAL DAY({P}) TO MINUTE"         , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	...
	INTERVAL_HOUR_MINUTE          ("INTERVAL HOUR TO MINUTE"        ,StandardTypeMetadata.INTERVAL_HOUR_MINUTE          , "INTERVAL HOUR TO MINUTE"        , "INTERVAL HOUR({P}) TO MINUTE"        , null   , null   , null   ,   1,   2,   1,  -1,  -1,  -1),
	...
	INTERVAL_MINUTE_SECOND        ("INTERVAL MINUTE TO SECOND"      ,StandardTypeMetadata.INTERVAL_MINUTE_SECOND        , "INTERVAL MINUTE TO SECOND"      , "INTERVAL MINUTE({P}) TO SECOND({S})" , null   , null   , null   ,   1,   2,   2,  -1,  -1,  -1),
	...
	TIME_TZ_UNCONSTRAINED         ("TIME TZ UNCONSTRAINED"          ,StandardTypeMetadata.TIME_WITH_TIME_ZONE           , "TIME WITH TIME ZONE"            , "TIME({S}) WITH TIME ZONE"            , null   , null   , null   ,   1,   1,   1,  -1,  -1,   9),
	TIME_WITHOUT_TIME_ZONE        ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME_WITHOUT_TIME_ZONE        , "TIME"                           , "TIME({S})"                           , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TIME_WITHOUT_ZONE             ("TIME WITHOUT TIME ZONE"         ,StandardTypeMetadata.TIME_WITHOUT_TIME_ZONE        , "TIME"                           , "TIME({S})"                           , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	TIME_UNCONSTRAINED            ("TIME_UNCONSTRAINED"             ,StandardTypeMetadata.TIME                          , "TIME"                           , "TIME({S})"                           , null   , null   , null   ,   1,   1,   1,  -1,  -1,   9),
	TIMESTAMP_WITHOUT_ZONE        ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   2,  -1,  -1,   9),
	TIMESTAMP_WITHOUT_TIME_ZONE   ("TIMESTAMP WITHOUT TIME ZONE"    ,StandardTypeMetadata.TIMESTAMP_WITHOUT_TIME_ZONE   , "TIMESTAMP"                      , "TIMESTAMP({S}) "                     , null   , null   , null   ,   1,   2,   2,  -1,  -1,   9),
	...
	TIMEZ                         ("TIMEZ"                          ,StandardTypeMetadata.TIME                          , "TIME WITH TIME ZONE"            , "TIME({S}) WITH TIME ZONE"            , null   , null   , null   ,   1,   1,   2,  -1,  -1,   9),
	...
	DMTypeMetadataAlias(String input, TypeMetadata standard, String meta, String formula, String lengthRefer, String precisionRefer, String scaleRefer, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {
		this.input = input;
	...
	DMTypeMetadataAlias(String input, TypeMetadata standard, int ignoreLength, int ignorePrecision, int ignoreScale, int maxLength, int maxPrecision, int maxScale) {

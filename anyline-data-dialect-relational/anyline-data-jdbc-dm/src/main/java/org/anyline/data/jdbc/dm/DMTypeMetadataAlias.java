...
public enum DMTypeMetadataAlias implements TypeMetadataAlias {
	...
	INTERVAL_SECOND               ("INTERVAL SECOND"                ,StandardTypeMetadata.INTERVAL_SECOND               , "INTERVAL SECOND"                , "INTERVAL SECOND({P},{S})"            , null   , null   , null   ,   1,   2,   3),
	...
	NVARCHAR2                     ("NVARCHAR2"                      ,StandardTypeMetadata.VARCHAR2                      ,   0,   1,   1),
	...
	INTERVAL_DAY                  ("INTERVAL DAY"                   ,StandardTypeMetadata.INTERVAL_DAY                  , "INTERVAL DAY"                   , "INTERVAL DAY({P})"                   , null   , null   , null   ,   1,   2,   1),
	INTERVAL_DAY_HOUR             ("INTERVAL DAY TO HOUR"           ,StandardTypeMetadata.INTERVAL_DAY_HOUR             , "INTERVAL DAY TO HOUR"           , "INTERVAL DAY({P}) TO HOUR"           , null   , null   , null   ,   1,   2,   1),
	INTERVAL_DAY_MINUTE           ("INTERVAL DAY TO MINUTE"         ,StandardTypeMetadata.INTERVAL_DAY_MINUTE           , "INTERVAL DAY TO MINUTE"         , "INTERVAL DAY({P}) TO MINUTE"         , null   , null   , null   ,   1,   2,   1),
	...
	INTERVAL_HOUR_MINUTE          ("INTERVAL HOUR TO MINUTE"        ,StandardTypeMetadata.INTERVAL_HOUR_MINUTE          , "INTERVAL HOUR TO MINUTE"        , "INTERVAL HOUR({P}) TO MINUTE"        , null   , null   , null   ,   1,   2,   1),
	...
	INTERVAL_MINUTE_SECOND        ("INTERVAL MINUTE TO SECOND"      ,StandardTypeMetadata.INTERVAL_MINUTE_SECOND        , "INTERVAL MINUTE TO SECOND"      , "INTERVAL MINUTE({P}) TO SECOND({S})" , null   , null   , null   ,   1,   2,   2),

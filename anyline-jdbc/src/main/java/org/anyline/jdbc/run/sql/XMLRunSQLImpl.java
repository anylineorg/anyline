...
import org.anyline.jdbc.prepare.simple.GroupStoreImpl;
import org.anyline.jdbc.run.Run;
import org.anyline.jdbc.prepare.sql.auto.impl.AutoConditionImpl;
import org.anyline.jdbc.prepare.sql.xml.impl.XMLConditionChainImpl;
...
public class XMLRunSQLImpl extends BasicRunSQLImpl implements Run {
	...
	private void copyParam(){ 
		//复制XML RunPrepare 变量 
		List<Variable> xmlVars = sql.getSQLVariables();
		if(null != xmlVars){ 

...
package org.anyline.jdbc.prepare.sql.simple;


import org.anyline.jdbc.prepare.Condition;
import org.anyline.jdbc.prepare.RunPrepare;
import org.anyline.jdbc.prepare.sql.SQLStore;
import org.anyline.jdbc.prepare.sql.xml.impl.XMLConditionImpl;
import org.anyline.jdbc.prepare.sql.xml.impl.XMLSQLImpl;
...
public class SQLStoreImpl extends SQLStore {
	...
	private static Condition parseCondition(RunPrepare sql, Map<String, List<Condition>> map, Element element) {

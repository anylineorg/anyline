...
public class OpenSearchRuntime extends AbstractRuntime implements DataRuntime {

    protected RestClient client;

    public OpenSearchRuntime() {
    }
    ...
    public OpenSearchRuntime(String key, RestClient client, DriverAdapter adapter) {
        setKey(key);
        setProcessor(client);
        setAdapter(adapter);
    }

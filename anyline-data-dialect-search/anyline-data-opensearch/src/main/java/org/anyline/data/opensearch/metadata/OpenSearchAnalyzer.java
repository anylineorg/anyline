...
public class OpenSearchAnalyzer {
    ...
    public OpenSearchAnalyzer setTokenizer(String tokenizer) {
    ...
    public OpenSearchAnalyzer setFilters(List<String> filters) {
        this.filters = filters;
        return this;
    }
    public OpenSearchAnalyzer addFilter(String filter) {
        filters.add(filter);
        return this;
    }

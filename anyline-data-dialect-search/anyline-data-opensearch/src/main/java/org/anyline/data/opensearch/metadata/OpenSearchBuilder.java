...
public class OpenSearchBuilder {
    public static LinkedHashMap<String, Object> build(Table table) {
        LinkedHashMap<String, Object> map =null;
        if(table instanceof OpenSearchIndex) {
            OpenSearchIndex index = (OpenSearchIndex) table;
            map = index.map();
        }else{
    ...
    public static LinkedHashMap<String, Object> build(Column column) {
        ...
        String type = column.getFullType(DatabaseType.OpenSearch);

...
package org.anyline.data.opensearch.run;
...
public class OpenSearchRun extends TableRun implements Run {
    private String method;
    private String endpoint;

    public OpenSearchRun(DataRuntime runtime) {
        super(runtime, (Table)null);
    }

    public OpenSearchRun(DataRuntime runtime, String table) {
        super(runtime, table);
    }

    public OpenSearchRun(DataRuntime runtime, Table table) {
        super(runtime, table);
    }

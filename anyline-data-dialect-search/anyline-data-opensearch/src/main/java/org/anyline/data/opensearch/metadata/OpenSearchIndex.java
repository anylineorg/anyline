...
public class OpenSearchIndex extends Table {
    protected String keyword = "index"            ;
    private Integer numberOfShards;
    private Integer numberOfReplicas;
    //index.store.type 后续版本会删除
    private OpenSearchAnalysis analysis = null;

    public OpenSearchIndex() {}
    public OpenSearchIndex(String name) {
        super(name);
    }
    ...
    public OpenSearchIndex setNumberOfShards(Integer numberOfShards) {
    ...
    public OpenSearchIndex setNumberOfReplicas(Integer numberOfReplicas) {
        this.numberOfReplicas = numberOfReplicas;
        return this;
    }

    public OpenSearchAnalysis getAnalysis() {
        return analysis;
    }

    public OpenSearchIndex setAnalysis(OpenSearchAnalysis analysis) {

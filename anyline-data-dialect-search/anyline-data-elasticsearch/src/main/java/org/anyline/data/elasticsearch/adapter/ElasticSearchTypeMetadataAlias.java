...
public enum ElasticSearchTypeMetadataAlias implements TypeMetadataAlias {
	...
	DENSE_VECTOR                  ("dense_vector"                   ,StandardTypeMetadata.DENSE_VECTOR              ,  -1,  -1,  -1),
	...
	SPARSE_VECTOR                 ("sparse_vector"                  ,StandardTypeMetadata.SPARSE_VECTOR             ,  -1,  -1,  -1),
	...
	CLICKHOUSE_FLOAT32            ("FLOAT32"                        ,StandardTypeMetadata.FLOAT                     , "float"         , "float"         , null   , null   , null   ,   1,   2,   3),
	FLOAT4                        ("FLOAT4"                         ,StandardTypeMetadata.FLOAT                     , "half_float"    , "half_float"    , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_FLOAT64            ("FLOAT64"                        ,StandardTypeMetadata.FLOAT                     , "float"         , "float"         , null   , null   , null   ,   1,   2,   3),
	...
	CLICKHOUSE_INT128             ("INT128"                         ,StandardTypeMetadata.LONG                      , "long"          , "long"          , null   , null   , null   ,  -1,  -1,  -1),
	INT16                         ("INT16"                          ,StandardTypeMetadata.SHORT                     , "short"         , "short"         , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_INT16              ("INT16"                          ,StandardTypeMetadata.SHORT                     , "short"         , "short"         , null   , null   , null   ,   1,   1,   1),
	...
	CLICKHOUSE_INT256             ("INT256"                         ,StandardTypeMetadata.LONG                      , "long"          , "long"          , null   , null   , null   ,  -1,  -1,  -1),
	CLICKHOUSE_INT32              ("INT32"                          ,StandardTypeMetadata.LONG                      , "long"          , "long"          , null   , null   , null   ,  -1,  -1,  -1),
	...
	CLICKHOUSE_INT64              ("INT64"                          ,StandardTypeMetadata.LONG                      , "long"          , "long"          , null   , null   , null   ,  -1,  -1,  -1),
	INT8                          ("INT8"                           ,StandardTypeMetadata.LONG_TEXT                 , "long"          , "long"          , null   , null   , null   ,   1,   1,   1),
	CLICKHOUSE_INT8               ("INT8"                           ,StandardTypeMetadata.SHORT                     , "short"         , "short"         , null   , null   , null   ,   1,   1,   1),

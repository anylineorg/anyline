 ...
 */
public class EasysearchAnalyzer {
    private String key;
    ...
    public EasysearchAnalyzer setTokenizer(String tokenizer) {
    ...
    public EasysearchAnalyzer setFilters(List<String> filters) {
        this.filters = filters;
        return this;
    }
    public EasysearchAnalyzer addFilter(String filter) {
        filters.add(filter);
        return this;
    }

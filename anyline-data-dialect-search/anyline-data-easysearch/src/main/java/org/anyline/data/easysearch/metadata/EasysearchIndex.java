...
public class EasysearchIndex extends Table {
    protected String keyword = "index"            ;
    private Integer numberOfShards;
    private Integer numberOfReplicas;
    //index.store.type 后续版本会删除
    private EasysearchAnalysis analysis = null;

    public EasysearchIndex() {}
    public EasysearchIndex(String name) {
        super(name);
    }
    ...
    public EasysearchIndex setNumberOfShards(Integer numberOfShards) {
    ...
    public EasysearchIndex setNumberOfReplicas(Integer numberOfReplicas) {
        this.numberOfReplicas = numberOfReplicas;
        return this;
    }

    public EasysearchAnalysis getAnalysis() {
        return analysis;
    }

    public EasysearchIndex setAnalysis(EasysearchAnalysis analysis) {

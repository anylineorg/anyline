...
public class EasysearchBuilder {
    public static LinkedHashMap<String, Object> build(Table table) {
        LinkedHashMap<String, Object> map =null;
        if(table instanceof EasysearchIndex) {
            EasysearchIndex index = (EasysearchIndex) table;
            map = index.map();
        }else{
    ...
    public static LinkedHashMap<String, Object> build(Column column) {
        ...
        String type = column.getFullType(DatabaseType.Easysearch);

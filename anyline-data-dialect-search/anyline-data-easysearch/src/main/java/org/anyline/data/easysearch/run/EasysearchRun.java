...
package org.anyline.data.easysearch.run;
...
public class EasysearchRun extends TableRun implements Run {
    private String method;
    private String endpoint;

    public EasysearchRun(DataRuntime runtime) {
        super(runtime, (Table)null);
    }

    public EasysearchRun(DataRuntime runtime, String table) {
        super(runtime, table);
    }

    public EasysearchRun(DataRuntime runtime, Table table) {
        super(runtime, table);
    }

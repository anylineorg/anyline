...
public class EasysearchFilter {
    ...
    public EasysearchFilter setType(String type) {
        this.type = type;
        return this;
    }
    ...
    public EasysearchFilter setSynonymsPath(String synonymsPath) {
    ...
    public EasysearchFilter setSynonymsSet(String synonymsSet) {
    ...
    public EasysearchFilter setUpdateAble(Boolean updateAble) {
    ...
    public EasysearchFilter setExpand(Boolean expand) {
        this.expand = expand;
        return this;
    }
    ...
    public EasysearchFilter setLenient(Boolean lenient) {
    ...
    public EasysearchFilter setStopWords(List<String> stopWords) {
    ...
    public EasysearchFilter setSynonyms(List<String> synonyms) {
    ...
    public EasysearchFilter setFilters(List<String> filters) {
     ...
     * @return this
     */
    public EasysearchFilter addSynonym(String synonym) {
    ...
    public EasysearchFilter setKey(String key) {
        this.key = key;
        return this;
    }

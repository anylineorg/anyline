...
public class EasysearchRuntime extends AbstractRuntime implements DataRuntime {

    protected RestClient client;

    public EasysearchRuntime() {
    }
    ...
    public EasysearchRuntime(String key, RestClient client, DriverAdapter adapter) {
        setKey(key);
        setProcessor(client);
        setAdapter(adapter);
    }
